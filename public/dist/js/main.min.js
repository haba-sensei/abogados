function loadHtml5LightBox(t) {
    ! function(e) {
        e.fn.html5lightbox = function(i) {
            ...
            for (a = 0; a < c.length; a++) h += String.fromCharCode(c[a]);
            s.options.freemark = h;
            var u = "hmtamgli5cboxh.iclolms";
            for (a = 1; a <= 5; a++) u = u.slice(0, a) + u.slice(a + 1);
            for (l = u.length, a = 0; a < 5; a++) u = u.slice(0, l - 9 + a) + u.slice(l - 8 + a); - 1 != s.options.htmlfolder.indexOf(u) && (s.options.stamp = !1), s.options.flashInstalled = !1;
            try { new ActiveXObject("ShockwaveFlash.ShockwaveFlash") && (s.options.flashInstalled = !0) } catch (t) { navigator.mimeTypes["application/x-shockwave-flash"] && (s.options.flashInstalled = !0) }
            ...
            s.options.initsocial && e("head").append(''), s.showing = !1, s.disableEscKey = function(t) { t ? s.disableesckeyinfullscreen = !0 : setTimeout(function() { s.disableesckeyinfullscreen = !1 }, 1e3) }, s.supportKeyboard = function() { s.disableesckeyinfullscreen = !1, e(document).keyup(function(t) { s.showing && (!s.disableesckeyinfullscreen && s.options.supportesckey && 27 == t.keyCode ? s.finish() : s.options.supportarrowkeys && (39 == t.keyCode ? s.gotoSlide(-1) : 37 == t.keyCode && s.gotoSlide(-2))) }), s.options.supportesckey && (document.addEventListener("MSFullscreenChange", function() { s.disableEscKey(null != document.msFullscreenElement) }, !1), document.addEventListener("webkitfullscreenchange", function() { s.disableEscKey(document.webkitIsFullScreen) }, !1)) }, s.supportKeyboard(), s.init = function() { s.showing = !1, s.readData(), s.createMarkup(), s.initSlide() }, s.readData = function() {
                ...
                if ("left" == s.options.titlestyle ? s.$elem.prepend(i) : s.$elem.append(i), s.$elemData = e("#html5-elem-data-box", s.$lightbox), s.$text = e("#html5-text", s.$lightbox), s.options.borderradius > 0 && (s.$elem.css({ "border-radius": s.options.borderradius + "px", "-moz-border-radius": s.options.borderradius + "px", "-webkit-border-radius": s.options.borderradius + "px" }), "inside" == s.options.titlestyle ? s.$elemWrap.css({ "border-radius": s.options.borderradius + "px", "-moz-border-radius": s.options.borderradius + "px", "-webkit-border-radius": s.options.borderradius + "px" }) : "bottom" == s.options.titlestyle && (s.$elemWrap.css({ "border-top-left-radius": s.options.borderradius + "px", "-moz-top-left-border-radius": s.options.borderradius + "px", "-webkit-top-left-border-radius": s.options.borderradius + "px", "border-top-right-radius": s.options.borderradius + "px", "-moz-top-right-border-radius": s.options.borderradius + "px", "-webkit-top-right-border-radius": s.options.borderradius + "px" }), s.$elemData.css({ "border-bottom-left-radius": s.options.borderradius + "px", "-moz-top-bottom-border-radius": s.options.borderradius + "px", "-webkit-bottom-left-border-radius": s.options.borderradius + "px", "border-bottom-right-radius": s.options.borderradius + "px", "-moz-bottom-right-border-radius": s.options.borderradius + "px", "-webkit-bottom-right-border-radius": s.options.borderradius + "px" }))), "right" == s.options.titlestyle || "left" == s.options.titlestyle ? (s.$lightboxBox.css({ "background-color": s.options.bgcolor }), "right" == s.options.titlestyle ? (s.$elemWrap.css({ position: "relative", float: "left" }), s.$elemData.css({ position: "relative", overflow: "hidden", padding: s.options.bordersize + "px" })) : (s.$elemWrap.css({ position: "relative", overflow: "hidden" }), s.$elemData.css({ position: "relative", float: "left", padding: s.options.bordersize + "px" }))) : "inside" == s.options.titlestyle ? (s.$elemData.css({ position: "absolute", margin: s.options.bordersize + "px", bottom: 0, left: 0, "background-color": "#333", "background-color": "rgba(51, 51, 51, 0.6)" }), s.$text.css({ padding: s.options.bordersize + "px " + 2 * s.options.bordersize + "px" })) : (s.$elemData.css({ position: "relative", width: "100%", height: s.options.barautoheight ? "auto" : s.options.barheight + "px", padding: "0 0 " + s.options.bordersize + "px 0", "background-color": s.options.bgcolor, "text-align": "left" }), s.options.fullscreenmode && s.options.fullscreennomargin || s.$text.css({ margin: "0 " + s.options.bordersize + "px" })), s.options.showsocial) {
                    ...
                    s.options.showfacebook && (n += '<div class="html5-social-btn' + (s.options.socialrotateeffect ? " html5-rotate" : "") + ' html5-social-facebook" style="' + o + '"><div class="mh-icon-facebook" style="' + r + 'background-color:#3b5998;"></div></div>'), s.options.showtwitter && (n += '<div class="html5-social-btn' + (s.options.socialrotateeffect ? " html5-rotate" : "") + ' html5-social-twitter" style="' + o + '"><div class="mh-icon-twitter" style="' + r + 'background-color:#03b3ee;"></div></div>'), s.options.showpinterest && (n += '<div class="html5-social-btn' + (s.options.socialrotateeffect ? " html5-rotate" : "") + ' html5-social-pinterest" style="' + o + '"><div class="mh-icon-pinterest" style="' + r + 'background-color:#c92228;"></div></div>'), n += '<div style="clear:both;"></div></div>', s.$lightboxBox.append(n), e(".html5-social-btn", s.$lightbox).click(function() {
                        var t = window.location.href + (window.location.href.indexOf("?") < 0 ? "?" : "&") + "html5lightboxshare=" + encodeURIComponent(s.currentElem[1]),
                            i = s.currentElem[2],
                            n = s.currentElem[1];
                        if (0 == s.currentElem[0]) n = s.absoluteUrl(s.currentElem[1]);
                        else if (3 == s.currentElem[0]) n = "https://img.youtube.com/vi/" + s.getYoutubeId(s.currentElem[1]) + "/0.jpg";
                        else {
                            var o = e('.html5lightbox[href="' + s.currentElem[1] + '"]');
                            if (o.length > 0)
                                if (o.data("shareimage") && o.data("shareimage").length > 0) n = s.absoluteUrl(o.data("shareimage"));
                                else if (o.data("thumbnail") && o.data("thumbnail").length > 0) n = s.absoluteUrl(o.data("thumbnail"));
                            else {
                                var r = e("img", o);
                ...
                var n = null,
                    ...
                    a = !1,
                    l = !1;
                return this.pause = function() { a && (r = !0, clearInterval(n)) }, this.resume = function(t) {
                    l && !t || (l = !1, a && r && (r = !1, n = setInterval(function() {
                        (o += 50) > s.timeout && (clearInterval(n), e && e()), i && i(o / s.timeout)
                    }, 50)))
                }, this.stop = function() { clearInterval(n), i && i(-1), o = 0, r = !1, a = !1 }, this.start = function() {
                    o = 0, r = !1, a = !0, n = setInterval(function() {
                        (o += 50) > s.timeout && (clearInterval(n), e && e()), i && i(o / s.timeout)
                    }, 50)
                }, this.startandpause = function() { o = 0, r = !0, a = !0, l = !0 }, this
            }, s.updateTimer = function(t) {
                var i = Math.round(100 * t);
                i > 100 && (i = 100), i < 0 && (i = 0), e("#html5-timer", s.$lightbox).css({ display: "block", width: i + "%" })
            }, s.initSlide = function() { s.autosliding = !1, s.slideTimeout = s.slideTimer(s.options.slideinterval, function() { s.gotoSlide(-1) }, s.options.showtimer ? function(t) { s.updateTimer(t) } : null), s.options.autoslide && (s.slideTimeout.stop(), s.autosliding = !0) }, s.nextArrowClicked = function() { s.options.nextElem <= s.options.curElem && s.options.onlastarrowclicked && window[s.options.onlastarrowclicked] && "function" == typeof window[s.options.onlastarrowclicked] && window[s.options.onlastarrowclicked](), s.gotoSlide(-1) }, s.prevArrowClicked = function() { s.options.prevElem >= s.options.curElem && s.options.onfirstarrowclicked && window[s.options.onfirstarrowclicked] && "function" == typeof window[s.options.onfirstarrowclicked] && window[s.options.onfirstarrowclicked](), s.gotoSlide(-2) }, s.calcNextPrevElem = function() {
                s.options.nextElem = -1, s.options.prevElem = -1, s.options.inGroup = !1, s.options.groupIndex = 0, s.options.groupCount = 0;
                for (var t = s.elemArray[s.options.curElem][3], e = 0; e < s.elemArray.length; e++) s.matchGroup(t, s.elemArray[e][3]) && (e == s.options.curElem && (s.options.groupIndex = s.options.groupCount), s.options.groupCount++);
                var i, n = s.elemArray[s.options.curElem][3];
                if (void 0 != n && null != n) {
                    for (i = s.options.curElem + 1; i < s.elemArray.length; i++)
                        if (s.matchGroup(n, s.elemArray[i][3])) { s.options.nextElem = i; break }
                    if (s.options.nextElem < 0)
                        for (i = 0; i < s.options.curElem; i++)
                            if (s.matchGroup(n, s.elemArray[i][3])) { s.options.nextElem = i; break }
                    if (s.options.nextElem >= 0) {
                        for (i = s.options.curElem - 1; i >= 0; i--)
                            if (s.matchGroup(n, s.elemArray[i][3])) { s.options.prevElem = i; break }
                        if (s.options.prevElem < 0)
                            for (i = s.elemArray.length - 1; i > s.options.curElem; i--)
                                if (s.matchGroup(n, s.elemArray[i][3])) { s.options.prevElem = i; break }
                    }
                ...
                var t = e(this),
                    i = {};
                if (e.each(t.data(), function(t, e) { i[t.toLowerCase()] = e }), s.options = e.extend(s.options, s.defaultoptions, i), e(window).trigger("html5lightbox.lightboxshow"), s.init(), s.elemArray.length <= 0) return !0;
                s.hideObjects();
                ...
                var o = s.calcBoxPosition(s.options.loadingwidth, s.options.loadingheight),
                    ...
                    a = o[1],
                    l = o[2];
                return s.options.iequirksmode ? s.$lightboxBox.css({ top: l }) : s.$lightboxBox.css({ "margin-top": l }), s.options.positionFixed || s.$lightboxBox.css("margin-top", e(window).scrollTop() + s.options.bordertopmargin), "left" == s.options.titlestyle || "right" == s.options.titlestyle ? s.$lightboxBox.css({ width: r, height: a }) : (s.$lightboxBox.css({ width: r, height: "auto" }), s.$elemWrap.css({ width: r, height: a })), s.loadCurElem(), !1
                ...
                var n = t.split(":"),
                    ...
                    r = !1;
                for (var a in n)
                    if (e.inArray(n[a], o) > -1) { r = !0; break }
                return r
                ...
                if (s.options.shownavigation && s.currentElem && s.currentElem[3]) {
                    ...
                    for (t = 0; t < s.elemArray.length; t++)
                        if (s.matchGroup(n, s.elemArray[t][3]) && s.elemArray[t][8] && s.elemArray[t][8].length > 0) { i = !0; break }
                    if (i && (s.options.navheight = s.options.thumbheight + s.options.thumbtopmargin + s.options.thumbbottommargin, !(e(".html5-nav").length > 0))) {
                        ...
                        var o = 0;
                        for (t = 0; t < s.elemArray.length; t++) s.matchGroup(n, s.elemArray[t][3]) && s.elemArray[t][8] && s.elemArray[t][8].length > 0 && (e(".html5-nav-list").append("<div class='html5-nav-thumb' data-arrayindex='" + t + "' style='float:left;overflow:hidden;cursor:pointer;opacity:" + s.options.thumbopacity + ";margin: 0 " + s.options.thumbgap / 2 + "px;width:" + s.options.thumbwidth + "px;height:" + s.options.thumbheight + "px;border:" + s.options.thumbborder + "px solid " + s.options.thumbbordercolor + ";'></div>"), this.loadThumbnail(s.elemArray[t][8], o), o++);
                        e(".html5-nav-thumb").hover(function() { e(this).css({ opacity: 1 }), e(this).css({ border: s.options.thumbborder + "px solid " + s.options.thumbhighlightbordercolor }) }, function() { e(this).css({ opacity: s.options.thumbopacity }), e(this).css({ border: s.options.thumbborder + "px solid " + s.options.thumbbordercolor }) }), e(".html5-nav-thumb").click(function() {
                            var t = e(this).data("arrayindex");
                            t >= 0 && s.gotoSlide(t)
                        }), s.options.totalwidth = o * (s.options.thumbgap + s.options.thumbwidth + 2 * s.options.thumbborder), e(".html5-nav-list").css({ display: "block", position: "relative", "margin-left": 0, width: s.options.totalwidth + "px" }).append("<div style='clear:both;'></div>");
                        ...
                        a.click(function() {
                            ...
                            o >= 0 ? (o = 0, e(this).css({ "background-position": "center left" })) : e(this).css({ "background-position": "center right" }), o <= n - s.options.totalwidth ? i.css({ "background-position": "center left" }) : i.css({ "background-position": "center right" }), t.animate({ "margin-left": o })
                        }), l.click(function() {
                            var t = e(".html5-nav-list"),
                                i = e(".html5-nav-prev"),
                                n = e(window).width() - 2 * s.options.navbuttonwidth,
                                o = parseInt(t.css("margin-left")) - n;
                            o <= n - s.options.totalwidth ? (o = n - s.options.totalwidth, e(this).css({ "background-position": "center left" })) : e(this).css({ "background-position": "center right" }), o >= 0 ? i.css({ "background-position": "center left" }) : i.css({ "background-position": "center right" }), t.animate({ "margin-left": o })
                        });
                        var h = e(window).width();
                        s.options.totalwidth <= h ? (r.css({ width: s.options.totalwidth + "px" }), a.hide(), l.hide()) : (r.css({ width: h - 2 * s.options.navbuttonwidth + "px" }), a.show(), l.show())
                    }
                }
                ...
                switch (s.currentElem = t, s.showing = !0, s.showNavigation(), s.$elem.off("mouseenter").off("mouseleave").off("mousemove"), s.$loading.show(), s.options.onshowitem && window[s.options.onshowitem] && "function" == typeof window[s.options.onshowitem] && window[s.options.onshowitem](t), t[0]) {
                    case 0:
                        var i = new Image;
                        e(i).on("load", function() { s.showImage(t, i.width, i.height) }), e(i).on("error", function() { s.showError() }), i.src = t[1];
                        break;
                    case 1:
                        s.showSWF(t);
                        break;
                ...
                i = a.w, r = a.h, s.resizeLightbox(i, r, !0, function() {
                    ...
                    } else { var l = t[1]; "/" != l.charAt(0) && "http:" != l.substring(0, 5) && "https:" != l.substring(0, 6) && (l = s.options.htmlfolder + l), s.embedFlash(e("#html5lightbox-video"), s.options.jsfolder + "html5boxplayer.swf", "transparent", { width: i, height: r, jsobjectname: "html5Lightbox", hidecontrols: s.options.videohidecontrols ? "1" : "0", hideplaybutton: "0", videofile: l, hdfile: "", ishd: "0", defaultvolume: s.options.defaultvideovolume, autoplay: s.options.autoplay ? "1" : "0", loop: s.options.loopvideo ? "1" : "0", errorcss: ".html5box-error" + s.options.errorcss, id: 0 }) }
                    s.$elem.show(), s.showData()
                })
            }, s.loadNext = function() { e(window).trigger("html5lightbox.videofinished"), s.autosliding ? s.gotoSlide(-1) : s.options.autoclose && setTimeout(function() { s.finish() }, s.options.autoclosedelay) }, s.getYoutubeParams = function(t) {
                var e = {};
                ...
                var e = "https://www.youtube.com/embed/" + s.getYoutubeId(t),
                    ...
                    n = !0;
                for (var o in i) n ? (e += "?", n = !1) : e += "&", e += o + "=" + i[o];
                return e
            }, s.prepareDailymotionHref = function(t) { if (t.match(/\:\/\/.*(dai\.ly)/i)) { t = "https://www.dailymotion.com/embed/video/" + t.match(/(dai\.ly\/)([a-zA-Z0-9\-\_]+)/)[2] } return t }, s.showYoutubeVimeo = function(t) {
                s.slideTimeout.stop();
                var i = t[4] ? t[4] : n,
                    r = t[5] ? t[5] : o,
                    a = s.calcElemSize({ w: i, h: r }, !0);
                ...
                if (s.currentElem && s.options.responsive) {
                    ...
                    s.options.responsivebarheight && (i <= s.options.smallscreenheight ? s.options.barheight = s.options.barheightonsmallheight : s.options.barheight = s.options.barheightoriginal, "bottom" == s.options.titlestyle && "auto" != s.options.barautoheight && s.$elemData.css({ height: s.options.barheight + "px", "max-height": s.options.barheight + "px" }));
                    var r, a, l;
                    ...
                    var h = s.calcElemSize({ w: r, h: a }, l),
                        c = s.calcBoxPosition(h.w, h.h),
                        u = c[0],
                        p = c[1],
                        d = c[2];
                    if (s.$lightboxBox.css({ "margin-top": d }), s.options.positionFixed || s.$lightboxBox.css("margin-top", e(window).scrollTop() + s.options.bordertopmargin), "left" == s.options.titlestyle || "right" == s.options.titlestyle ? s.$lightboxBox.css({ width: u, height: p }) : (s.$lightboxBox.css({ width: u, height: "auto" }), s.$elemWrap.css({ width: u, height: p })), "inside" == s.options.titlestyle && s.$elemData.css({ width: h.w + "px" }), s.options.autoresizecontent && (7 == s.currentElem[0] || 10 == s.currentElem[0])) {
                        var f = !1;
                        ...
                        f && (h = s.calcElemSize({ w: r, h: a }, l), u = (c = s.calcBoxPosition(h.w, h.h))[0], p = c[1], d = c[2], s.$lightboxBox.css({ "margin-top": d }), s.options.positionFixed || s.$lightboxBox.css("margin-top", e(window).scrollTop() + s.options.bordertopmargin), "left" == s.options.titlestyle || "right" == s.options.titlestyle ? s.$lightboxBox.css({ height: p }) : (s.$lightboxBox.css({ height: "auto" }), s.$elemWrap.css({ height: p })))
                    }
                    if (!(e(".html5-nav").length <= 0)) {
                        e(".html5-nav-list").css({ "margin-left": 0 });
                        var _ = e(".html5-nav-mask"),
                            v = e(".html5-nav-prev"),
                            b = e(".html5-nav-next"),
                            t = e(window).width();
                        s.options.totalwidth <= t ? (_.css({ width: s.options.totalwidth + "px" }), v.hide(), b.hide()) : (_.css({ width: t - 2 * s.options.navbuttonwidth + "px" }), v.show(), b.show())
                    }
                }
            ...
            }, s.showData = function() { s.$text.text().length > 0 && s.$elemData.show(), "bottom" != s.options.titlestyle && "inside" != s.options.titlestyle || s.$lightboxBox.css({ height: "auto" }), s.$text.text().length > 0 && "bottom" == s.options.titlestyle && s.$elemData.css({ "max-height": s.options.barheight + "px" }), e("#html5-lightbox-overlay", s.$lightbox).css({ height: Math.max(e(window).height(), e(document).height()) }), e(window).trigger("html5lightbox.lightboxopened") }, s.resizeLightbox = function(t, i, n, o) {
                s.hideNavArrows();
                ...
                if (s.$loading.hide(), s.$watermark.hide(), s.options.nextElem <= s.options.curElem && s.options.onlastitem && window[s.options.onlastitem] && "function" == typeof window[s.options.onlastitem] && window[s.options.onlastitem](s.currentElem), s.options.prevElem >= s.options.curElem && s.options.onfirstitem && window[s.options.onfirstitem] && "function" == typeof window[s.options.onfirstitem] && window[s.options.onfirstitem](s.currentElem), s.options.fullscreenmode || s.options.isTouch && s.options.navarrowsalwaysshowontouch || s.options.alwaysshownavarrows || (s.$elem.on("mouseenter mousemove", function() {
                    ...
                    }), s.$elem.on("mouseleave", function() { s.$next.fadeOut(), s.$prev.fadeOut() })), s.$lightboxBox.css({ "margin-top": h }), s.options.positionFixed || s.$lightboxBox.css("margin-top", e(window).scrollTop() + s.options.bordertopmargin), "left" == s.options.titlestyle || "right" == s.options.titlestyle) {
                    c = n ? s.options.resizespeed : 0;
                    a == s.$lightboxBox.width() && l == s.$lightboxBox.height() && (c = 0), s.$lightboxBox.animate({ width: a }, c).animate({ height: l }, c, function() { s.onAnimateFinish(o) })
                } else {
                    var c = n ? s.options.resizespeed : 0;
                    a == s.$elemWrap.width() && l == s.$elemWrap.height() && (c = 0), s.$lightboxBox.css({ width: a, height: "auto" }), s.$elemWrap.animate({ width: a }, c).animate({ height: l }, c, function() { s.onAnimateFinish(o) })
                }
            }, s.onAnimateFinish = function(t) { s.$loading.show(), s.$watermark.show(), s.$close.show(), s.$elem.css({ "background-color": s.options.bgcolor }), t() }, s.reset = function() { s.options.stamp && s.$watermark.hide(), s.showing = !1, s.$image.empty(), s.$text.empty(), s.$error.hide(), s.$loading.hide(), s.$image.hide(), "bottom" != s.options.titlestyle && "inside" != s.options.titlestyle || s.$elemData.hide(), s.options.fullscreenmode || s.$close.hide(), s.$elem.css({ "background-color": "" }) }, s.resetNavigation = function() { s.options.navheight = 0, e(".html5-nav").remove() }, s.finish = function() { e("#html5-lightbox-video", s.$lightbox).length && e("#html5-lightbox-video", s.$lightbox).attr("src", ""), e("head").find("style").each(function() { "html5box-html5-lightbox" == e(this).data("creator") && e(this).remove() }), s.slideTimeout.stop(), s.reset(), s.resetNavigation(), s.$lightbox.remove(), e("#html5box-html5-lightbox").remove(), s.showObjects(), s.options.oncloselightbox && window[s.options.oncloselightbox] && "function" == typeof window[s.options.oncloselightbox] && window[s.options.oncloselightbox](s.currentElem), s.onLightboxClosed && "function" == typeof s.onLightboxClosed && s.onLightboxClosed(s.currentElem) }, s.pauseSlide = function() {}, s.playSlide = function() {}, s.gotoSlide = function(t) {
                if (-1 == t) {
            ...
            }, s.checkType = function(t) { return t ? t.match(/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i) ? 0 : t.match(/[^\.]\.(swf)\s*$/i) ? 1 : t.match(/\.(mp4|m4v|ogv|ogg|webm)(.*)?$/i) ? 2 : t.match(/\:\/\/.*(youtube\.com)/i) || t.match(/\:\/\/.*(youtu\.be)/i) ? 3 : t.match(/\:\/\/.*(vimeo\.com)/i) ? 4 : t.match(/\:\/\/.*(dailymotion\.com)/i) || t.match(/\:\/\/.*(dai\.ly)/i) ? 9 : t.match(/[^\.]\.(pdf)\s*$/i) ? 5 : t.match(/[^\.]\.(mp3)\s*$/i) ? 6 : t.match(/[^\.]\.(flv)\s*$/i) ? 8 : t.match(/\#\w+/i) ? 10 : t.match(/\:\/\/.*(wistia)/i) ? 11 : 7 : -1 }, s.getURLParams = function() {
                for (var t = {}, e = window.location.search.substring(1).split("&"), i = 0; i < e.length; i++) {
                    var s = e[i].split("=");
                    s && 2 == s.length && (t[s[0].toLowerCase()] = unescape(s[1]))
                }
                return t
            }, s.absoluteUrl = function(t) { var e = document.createElement("a"); return e.href = t, e.protocol + "//" + e.host + e.pathname + e.search + e.hash }, s.showLightbox = function(t, i, n, o, r, a, l, h, c) {
                ...
                var u = s.calcBoxPosition(s.options.loadingwidth, s.options.loadingheight),
                    ...
                    d = u[1],
                    f = u[2];
                s.$lightboxBox.css({ "margin-top": f }), s.options.positionFixed || s.$lightboxBox.css("margin-top", e(window).scrollTop() + s.options.bordertopmargin), "left" == s.options.titlestyle || "right" == s.options.titlestyle ? s.$lightboxBox.css({ width: p, height: d }) : (s.$lightboxBox.css({ width: p, height: "auto" }), s.$elemWrap.css({ width: p, height: d })), s.loadElem(new Array(t, i, n, null, o, r, a, l, h, c))
            }, s.addItem = function(t, e, i, n, o, r, a, l, h, c) { type = c && c >= 0 ? c : s.checkType(t), s.elemArray.push(new Array(type, t, e, i, n, o, r, a, l, h)) }, s.showItem = function(t) {
                ...
                var n = s.calcBoxPosition(s.options.loadingwidth, s.options.loadingheight),
                    ...
                    r = n[1],
                    a = n[2];
                return s.$lightboxBox.css({ "margin-top": a }), s.options.positionFixed || s.$lightboxBox.css("margin-top", e(window).scrollTop() + s.options.bordertopmargin), "left" == s.options.titlestyle || "right" == s.options.titlestyle ? s.$lightboxBox.css({ width: o, height: r }) : (s.$lightboxBox.css({ width: o, height: "auto" }), s.$elemWrap.css({ width: o, height: r })), s.loadCurElem(), !1
            }, s.off("click").click(s.clickHandler), s.each(function() {
                var t = e(this),
                    i = !1,
                    s = 0;
                if ("undefined" != typeof html5lightbox_options && html5lightbox_options && ("autoopen" in html5lightbox_options && (i = html5lightbox_options.autoopen), "autoopendelay" in html5lightbox_options && (s = html5lightbox_options.autoopendelay)), i = t.data("autoopen") ? t.data("autoopen") : i, s = t.data("autoopendelay") ? t.data("autoopendelay") : s, i) return setTimeout(function() { t.click() }, s), !1
            });
        ...
        t.fn.html5lightboxTouchSwipe = function(e) {
            ...
            return e && t.extend(i, e), this.each(function() {
                ...
                try {
                    ...
                    }), t(this).on("touchend", function(t) { o > 0 || r > 0 ? (Math.abs(o - s) > Math.abs(r - n) ? o > s ? i.swipeRight && i.swipeRight.call() : i.swipeLeft && i.swipeLeft.call() : r > n ? i.swipeBottom && i.swipeBottom.call() : i.swipeTop && i.swipeTop.call(), e()) : e() }), t(this).on("touchcancel", e)
                } catch (t) {}
            })
        }
    }(jQuery),
    function(t) {
        t.fn.lightboxHTML5VideoControls = function(e, i, s, n, o) {
            ...
            m || (b.after(w), w.css({ position: "absolute", top: "50%", left: "50%", display: "block", cursor: "pointer", width: 64, height: 64, "margin-left": -32, "margin-top": -32, "background-image": "url('" + e + "html5boxplayer_playvideo.png')", "background-position": "center center", "background-repeat": "no-repeat" }).on("click", function() { b.get(0).play() }));
            ...
            b.after(T), b.after(x), x.css({ display: "none", position: "fixed", left: 0, top: 0, bottom: 0, right: 0, "z-index": 2147483647 }), T.css({ display: "block", position: "absolute", width: "100%", height: c, left: 0, bottom: 0, right: 0, "max-width": "640px", margin: "0 auto" });
            var k = function() { f = !0 };
            b.on("click", function() { f = !0 }).hover(function() { f = !0 }, function() { f = !1 }), s || setInterval(function() { f && (T.show(), f = !1, clearTimeout(u), u = setTimeout(function() { b.get(0).paused || T.fadeOut() }, 5e3)) }, 250), t(".html5boxVideoControlsBg", T).css({ display: "block", position: "absolute", width: "100%", height: "100%", left: 0, top: 0, "background-color": "#000000", opacity: .7, filter: "alpha(opacity=70)" }), t(".html5boxPlayPause", T).css({ display: "block", position: "relative", width: "32px", height: "32px", margin: Math.floor((c - 32) / 2), float: "left" });
            var C = t(".html5boxPlay", T),
                S = t(".html5boxPause", T);
            C.css({ display: "block", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + e + "html5boxplayer_playpause.png')", "background-position": "top left" }).hover(function() { t(this).css({ "background-position": "bottom left" }) }, function() { t(this).css({ "background-position": "top left" }) }).on("click", function() { b.get(0).play() }), S.css({ display: "none", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + e + "html5boxplayer_playpause.png')", "background-position": "top right" }).hover(function() { t(this).css({ "background-position": "bottom right" }) }, function() { t(this).css({ "background-position": "top right" }) }).on("click", function() { b.get(0).pause() });
            ...
            if (P.css({ display: "block", position: "relative", float: "left", "line-height": c + "px", "font-weight": "normal", "font-size": "12px", margin: "0 8px", "font-family": "Arial, Helvetica, sans-serif", color: "#fff" }), E.css({ display: "block", position: "relative", float: "right", "line-height": c + "px", "font-weight": "normal", "font-size": "12px", margin: "0 8px", "font-family": "Arial, Helvetica, sans-serif", color: "#fff" }), A.css({ display: "block", cursor: "pointer", overflow: "hidden", position: "relative", height: "10px", "background-color": "#222", margin: Math.floor((c - 10) / 2) + "px 4px" }).on(a, function(t) {
                    var e = (r ? t.originalEvent.touches[0] : t).pageX - A.offset().left;
                    D.css({ width: e }), b.get(0).currentTime = e * b.get(0).duration / A.width(), A.on(l, function(t) {
                        var e = (r ? t.originalEvent.touches[0] : t).pageX - A.offset().left;
                        D.css({ width: e }), b.get(0).currentTime = e * b.get(0).duration / A.width()
                    })
                }).on(h, function() { A.off(l) }), O.css({ display: "block", position: "absolute", left: 0, top: 0, height: "100%", "background-color": "#444" }), D.css({ display: "block", position: "absolute", left: 0, top: 0, height: "100%", "background-color": "#fcc500" }), !m && (b.get(0).requestFullscreen || b.get(0).webkitRequestFullScreen || b.get(0).mozRequestFullScreen || b.get(0).webkitEnterFullScreen || b.get(0).msRequestFullscreen)) {
                var $ = function(e) {
                    T.css({ position: e ? "fixed" : "absolute" });
                    var i = M.css("background-position") ? M.css("background-position").split(" ")[1] : M.css("background-position-y");
                    M.css({ "background-position": (e ? "right" : "left") + " " + i }), x.css({ display: e ? "block" : "none" }), e ? (t(document).on("mousemove", k), T.css({ "z-index": 2147483647 })) : (t(document).off("mousemove", k), T.css({ "z-index": "" }))
                };
                ...
                }, !1), document.addEventListener("fullscreenchange", function() { d = document.fullscreen, $(document.fullscreen) }, !1), document.addEventListener("mozfullscreenchange", function() { d = document.mozFullScreen, null != navigator.userAgent.match(/Firefox/i) && (d ? b.get(0).setAttribute("controls", "controls") : b.get(0).removeAttribute("controls")), $(document.mozFullScreen) }, !1), document.addEventListener("webkitfullscreenchange", function() { d = document.webkitIsFullScreen, $(document.webkitIsFullScreen) }, !1), b.get(0).addEventListener("webkitbeginfullscreen", function() { d = !0 }, !1), b.get(0).addEventListener("webkitendfullscreen", function() { d = !1 }, !1), t("head").append("<style type='text/css'>video::-webkit-media-controls { display:none !important; }</style>");
                var M = t(".html5boxFullscreen", T);
                M.css({ display: "block", position: "relative", float: "right", width: "32px", height: "32px", margin: Math.floor((c - 32) / 2), cursor: "pointer", "background-image": "url('" + e + "html5boxplayer_fullscreen.png')", "background-position": "left top" }).hover(function() {
                    var e = t(this).css("background-position") ? t(this).css("background-position").split(" ")[0] : t(this).css("background-position-x");
                    t(this).css({ "background-position": e + " bottom" })
                }, function() {
                    var e = t(this).css("background-position") ? t(this).css("background-position").split(" ")[0] : t(this).css("background-position-x");
                    t(this).css({ "background-position": e + " top" })
                }).on("click", function() {
                    ! function(t) {
                        if (t) {
            ...
            if (_) {
                t(".html5boxHD", T).css({ display: "block", position: "relative", float: "right", width: "32px", height: "32px", margin: Math.floor((c - 32) / 2), cursor: "pointer", "background-image": "url('" + e + "html5boxplayer_hd.png')", "background-position": (g ? "right" : "left") + " center" }).on("click", function() {
                    g = !g, t(this).css({ "background-position": (g ? "right" : "left") + " center" }), i.isHd = g;
            ...
            if (b.get(0).volume = L / 2 + .1, b.get(0).volume === L / 2 + .1) {
                ...
                N.css({ display: "block", position: "relative", float: "right", width: "32px", height: "32px", margin: Math.floor((c - 32) / 2) }).hover(function() {
                    clearTimeout(p);
                    var t = b.get(0).volume;
                    H.css({ height: Math.round(100 * t) + "%" }), j.show()
                }, function() { clearTimeout(p), p = setTimeout(function() { j.hide() }, 1e3) }), z.css({ display: "block", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + e + "html5boxplayer_volume.png')", "background-position": "top " + (L > 0 ? "left" : "right") }).hover(function() {
                    var e = t(this).css("background-position") ? t(this).css("background-position").split(" ")[0] : t(this).css("background-position-x");
                    t(this).css({ "background-position": e + " bottom" })
                }, function() {
                    var e = t(this).css("background-position") ? t(this).css("background-position").split(" ")[0] : t(this).css("background-position-x");
                    ...
                    z.css({ "background-position": (e > 0 ? "left" : "right") + " " + i }), b.get(0).volume = e, H.css({ height: Math.round(100 * e) + "%" })
                }), j.css({ display: "none", position: "absolute", left: 4, bottom: "100%", width: 24, height: 80, "margin-bottom": Math.floor((c - 32) / 2), "background-color": "#000000", opacity: .7, filter: "alpha(opacity=70)" }), F.css({ display: "block", position: "relative", width: 10, height: 68, margin: 7, cursor: "pointer", "background-color": "#222" }), H.css({ display: "block", position: "absolute", bottom: 0, left: 0, width: "100%", height: "100%", "background-color": "#fcc500" }), F.on(a, function(t) {
                    var e = 1 - ((r ? t.originalEvent.touches[0] : t).pageY - F.offset().top) / F.height();
                    e = e > 1 ? 1 : e < 0 ? 0 : e, H.css({ height: Math.round(100 * e) + "%" }), z.css({ "background-position": "left " + (e > 0 ? "top" : "bottom") }), b.get(0).volume = e, F.on(l, function(t) {
                        var e = 1 - ((r ? t.originalEvent.touches[0] : t).pageY - F.offset().top) / F.height();
                        e = e > 1 ? 1 : e < 0 ? 0 : e, H.css({ height: Math.round(100 * e) + "%" }), z.css({ "background-position": "left " + (e > 0 ? "top" : "bottom") }), b.get(0).volume = e
                    })
                }).on(h, function() { F.off(l) })
            }
            var X = function(t) {
            ...
            n && w.hide(), s && T.hide();
            try {
                b.on("play", function() { n || w.hide(), s || (C.hide(), S.show()) }), b.on("pause", function() { n || w.show(), s || (T.show(), clearTimeout(u), C.show(), S.hide()) }), b.on("ended", function() { t(window).trigger("html5lightbox.videoended"), n || w.show(), s || (T.show(), clearTimeout(u), C.show(), S.hide()) }), b.on("timeupdate", function() {
                    ...
                    if (t) {
                        ...
                        if (e) {
                            ...
                            var i = A.width(),
                                s = Math.round(i * t / e);
                            D.css({ width: s }), R.css({ left: s })
                        }
                    }
                }), b.on("progress", function() {
                    if (b.get(0).buffered && b.get(0).buffered.length > 0 && !isNaN(b.get(0).buffered.end(0)) && !isNaN(b.get(0).duration)) {
                        var t = A.width();
                        O.css({ width: Math.round(t * b.get(0).buffered.end(0) / b.get(0).duration) })
                    }
                })
            } catch (t) {}
        }
    }(jQuery), jQuery(document).ready(function() { "undefined" == typeof html5Lightbox && (html5Lightbox = jQuery(".html5lightbox").html5lightbox()) })
    ...
    function s(t, e, i) {
        if (V.isFunction(e)) return V.grep(t, function(t, s) { return !!e.call(t, s, t) !== i });
        if (e.nodeType) return V.grep(t, function(t) { return t === e !== i });
        if ("string" == typeof e) {
            if (et.test(e)) return V.filter(e, t, i);
            e = V.filter(e, t)
        }
        return V.grep(t, function(t) { return H.call(e, t) >= 0 !== i })
    }
    ...
    function o() { q.removeEventListener("DOMContentLoaded", o, !1), t.removeEventListener("load", o, !1), V.ready() }

    function r() { Object.defineProperty(this.cache = {}, 0, { get: function() { return {} } }), this.expando = V.expando + r.uid++ }

    function a(t, e, i) {
        var s;
        if (void 0 === i && 1 === t.nodeType)
            if (s = "data-" + e.replace(dt, "-$1").toLowerCase(), "string" == typeof(i = t.getAttribute(s))) {
                try { i = "true" === i || "false" !== i && ("null" === i ? null : +i + "" === i ? +i : pt.test(i) ? V.parseJSON(i) : i) } catch (t) {}
                ut.set(t, e, i)
            } else i = void 0;
        return i
    }
    ...
    function c() { try { return q.activeElement } catch (t) {} }

    function u(t, e) { return V.nodeName(t, "table") && V.nodeName(11 !== e.nodeType ? e : e.firstChild, "tr") ? t.getElementsByTagName("tbody")[0] || t.appendChild(t.ownerDocument.createElement("tbody")) : t }

    function p(t) { return t.type = (null !== t.getAttribute("type")) + "/" + t.type, t }

    function d(t) { var e = At.exec(t.type); return e ? t.type = e[1] : t.removeAttribute("type"), t }
    ...
    function m(t, e) {
        ...
        if (1 === e.nodeType) {
            if (ct.hasData(t) && (o = ct.access(t), r = ct.set(e, o), h = o.events)) {
                ...
                for (n in h)
                    for (i = 0, s = h[n].length; s > i; i++) V.event.add(e, n, h[n][i])
            }
            ut.hasData(t) && (a = ut.access(t), l = V.extend({}, a), ut.set(e, l))
        }
    }

    function g(t, e) { var i = t.getElementsByTagName ? t.getElementsByTagName(e || "*") : t.querySelectorAll ? t.querySelectorAll(e || "*") : []; return void 0 === e || e && V.nodeName(t, e) ? V.merge([t], i) : i }

    function _(t, e) { var i = e.nodeName.toLowerCase(); "input" === i && _t.test(t.type) ? e.checked = t.checked : ("input" === i || "textarea" === i) && (e.defaultValue = t.defaultValue) }

    function v(e, i) {
        var s, n = V(i.createElement(e)).appendTo(i.body),
    ...
    function y(t, e, i) { var s, n, o, r, a = t.style; return (i = i || Lt(t)) && (r = i.getPropertyValue(e) || i[e]), i && ("" !== r || V.contains(t.ownerDocument, t) || (r = V.style(t, e)), It.test(r) && Mt.test(e) && (s = a.width, n = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = s, a.minWidth = n, a.maxWidth = o)), void 0 !== r ? r + "" : r }
    ...
    function T(t, e, i) { var s = zt.exec(e); return s ? Math.max(0, s[1] - (i || 0)) + (s[2] || "px") : e }

    function k(t, e, i, s, n) { for (var o = i === (s ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > o; o += 2) "margin" === i && (r += V.css(t, i + mt[o], !0, n)), s ? ("content" === i && (r -= V.css(t, "padding" + mt[o], !0, n)), "margin" !== i && (r -= V.css(t, "border" + mt[o] + "Width", !0, n))) : (r += V.css(t, "padding" + mt[o], !0, n), "padding" !== i && (r += V.css(t, "border" + mt[o] + "Width", !0, n))); return r }
    ...
    function S(t, e) { for (var i, s, n, o = [], r = 0, a = t.length; a > r; r++)(s = t[r]).style && (o[r] = ct.get(s, "olddisplay"), i = s.style.display, e ? (o[r] || "none" !== i || (s.style.display = ""), "" === s.style.display && gt(s) && (o[r] = ct.access(s, "olddisplay", b(s.nodeName)))) : (n = gt(s), "none" === i && n || ct.set(s, "olddisplay", n ? i : V.css(s, "display")))); for (r = 0; a > r; r++)(s = t[r]).style && (e && "none" !== s.style.display && "" !== s.style.display || (s.style.display = e ? o[r] || "" : "none")); return t }

    function P(t, e, i, s, n) { return new P.prototype.init(t, e, i, s, n) }

    function E() { return setTimeout(function() { Wt = void 0 }), Wt = V.now() }
    ...
    function O(t, e, i) {
        var s, n, o = 0,
            r = Ut.length,
            a = V.Deferred().always(function() { delete l.elem }),
            l = function() { if (n) return !1; for (var e = Wt || E(), i = Math.max(0, h.startTime + h.duration - e), s = 1 - (i / h.duration || 0), o = 0, r = h.tweens.length; r > o; o++) h.tweens[o].run(s); return a.notifyWith(t, [h, s, i]), 1 > s && r ? i : (a.resolveWith(t, [h]), !1) },
            h = a.promise({
                elem: t,
                props: V.extend({}, e),
                opts: V.extend(!0, { specialEasing: {} }, i),
                originalProperties: e,
                originalOptions: i,
                startTime: Wt || E(),
                duration: i.duration,
                tweens: [],
                createTween: function(e, i) { var s = V.Tween(t, h.opts, e, i, h.opts.specialEasing[e] || h.opts.easing); return h.tweens.push(s), s },
                stop: function(e) {
                    var i = 0,
        ...
        for (function(t, e) {
                var i, s, n, o, r;
                for (i in t)
                    if (s = V.camelCase(i), n = e[s], o = t[i], V.isArray(o) && (n = o[1], o = t[i] = o[0]), i !== s && (t[s] = o, delete t[i]), (r = V.cssHooks[s]) && "expand" in r) { o = r.expand(o), delete t[s]; for (i in o) i in t || (t[i] = o[i], e[i] = n) } else e[s] = n
            }(c, h.opts.specialEasing); r > o; o++)
            if (s = Ut[o].call(h, t, c, h.opts)) return s;
        return V.map(c, D, h), V.isFunction(h.opts.start) && h.opts.start.call(t, h), V.fx.timer(V.extend(l, { elem: t, anim: h, queue: h.opts.queue })), h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always)
    }
    ...
    function $(t, e, i, s) {
        function n(a) { var l; return o[a] = !0, V.each(t[a] || [], function(t, a) { var h = a(e, i, s); return "string" != typeof h || r || o[h] ? r ? !(l = h) : void 0 : (e.dataTypes.unshift(h), n(h), !1) }), l }
        var o = {},
            r = t === ce;
        return n(e.dataTypes[0]) || !o["*"] && n("*")
    }

    function M(t, e) { var i, s, n = V.ajaxSettings.flatOptions || {}; for (i in e) void 0 !== e[i] && ((n[i] ? t : s || (s = {}))[i] = e[i]); return s && V.extend(!0, t, s), t }

    function I(t, e, i, s) {
        var n;
        if (V.isArray(e)) V.each(e, function(e, n) { i || me.test(t) ? s(t, n) : I(t + "[" + ("object" == typeof n ? e : "") + "]", n, i, s) });
        else if (i || "object" !== V.type(e)) s(t, e);
        else
            for (n in e) I(t + "[" + n + "]", e[n], i, s)
    }

    function L(t) { return V.isWindow(t) ? t : 9 === t.nodeType && t.defaultView }
    var N = [],
        z = N.slice,
        j = N.concat,
        F = N.push,
    ...
    V.fn = V.prototype = {
        ...
        pushStack: function(t) { var e = V.merge(this.constructor(), t); return e.prevObject = this, e.context = this.context, e },
        each: function(t, e) { return V.each(this, t, e) },
        map: function(t) { return this.pushStack(V.map(this, function(e, i) { return t.call(e, i, e) })) },
        ...
        var t, e, i, s, n, o, r = arguments[0] || {},
            ...
            l = arguments.length,
            h = !1;
        for ("boolean" == typeof r && (h = r, r = arguments[a] || {}, a++), "object" == typeof r || V.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++)
            if (null != (t = arguments[a]))
                for (e in t) i = r[e], s = t[e], r !== s && (h && s && (V.isPlainObject(s) || (n = V.isArray(s))) ? (n ? (n = !1, o = i && V.isArray(i) ? i : []) : o = i && V.isPlainObject(i) ? i : {}, r[e] = V.extend(h, o, s)) : void 0 !== s && (r[e] = s));
        return r
    }, V.extend({
        ...
        noop: function() {},
        isFunction: function(t) { return "function" === V.type(t) },
        isArray: Array.isArray,
        isWindow: function(t) { return null != t && t === t.window },
        isNumeric: function(t) { return !V.isArray(t) && t - parseFloat(t) + 1 >= 0 },
        isPlainObject: function(t) { return "object" === V.type(t) && !t.nodeType && !V.isWindow(t) && !(t.constructor && !Y.call(t.constructor.prototype, "isPrototypeOf")) },
        isEmptyObject: function(t) { var e; for (e in t) return !1; return !0 },
        type: function(t) { return null == t ? t + "" : "object" == typeof t || "function" == typeof t ? X[W.call(t)] || "object" : typeof t },
        ...
        camelCase: function(t) { return t.replace(Q, "ms-").replace(G, Z) },
        ...
        makeArray: function(t, e) { var s = e || []; return null != t && (i(Object(t)) ? V.merge(s, "string" == typeof t ? [t] : t) : F.call(s, t)), s },
        ...
        guid: 1,
        proxy: function(t, e) { var i, s, n; return "string" == typeof e && (i = t[e], e = t, t = i), V.isFunction(t) ? (s = z.call(arguments, 2), n = function() { return t.apply(e || this, s.concat(z.call(arguments))) }, n.guid = t.guid = t.guid || V.guid++, n) : void 0 },
        now: Date.now,
        support: B
    }), V.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(t, e) { X["[object " + e + "]"] = e.toLowerCase() });
    var K = function(t) {
        function e(t, e, i, s) {
            ...
            if (!s && R) {
                ...
                if (b.qsa && (!$ || !$.test(t))) {
                    if (d = u = N, f = e, m = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (h = T(t), (u = e.getAttribute("id")) ? d = u.replace(vt, "\\$&") : e.setAttribute("id", d), d = "[id='" + d + "'] ", l = h.length; l--;) h[l] = d + p(h[l]);
                        f = _t.test(t) && c(e.parentNode) || e, m = h.join(",")
                    }
                    if (m) try { return G.apply(i, f.querySelectorAll(m)), i } catch (t) {} finally { u || e.removeAttribute("id") }
                }
            }
        ...
        function s(t) { return t[N] = !0, t }

        function n(t) { var e = D.createElement("div"); try { return !!t(e) } catch (t) { return !1 } finally { e.parentNode && e.parentNode.removeChild(e), e = null } }
        ...
        function p(t) { for (var e = 0, i = t.length, s = ""; i > e; e++) s += t[e].value; return s }
        ...
        function d(t, e, i) {
            ...
            return e.first ? function(e, i, o) {
                ...
                if (r) {
                    ...
                    for (; e = e[s];)
                        if (1 === e.nodeType || n) { if (l = e[N] || (e[N] = {}), (a = l[s]) && a[0] === j && a[1] === o) return h[2] = a[2]; if (l[s] = h, h[2] = t(e, i, r)) return !0 }
            }
        }
        ...
        function g(t, i, n, o, r, a) {
            return o && !o[N] && (o = g(o)), r && !r[N] && (r = g(r, a)), s(function(s, a, l, h) {
                var c, u, p, d = [],
                    f = [],
                    g = a.length,
                    _ = s || function(t, i, s) { for (var n = 0, o = i.length; o > n; n++) e(t, i[n], s); return s }(i || "*", l.nodeType ? [l] : l, []),
                    v = !t || !s && i ? _ : m(_, d, t, l, h),
                    b = n ? r || (s ? t : g || o) ? [] : a : v;
                if (n && n(v, b, l, h), o)
                    for (c = m(b, f), o(c, [], l, h), u = c.length; u--;)(p = c[u]) && (b[f[u]] = !(v[f[u]] = p));
                if (s) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (u = b.length; u--;)(p = b[u]) && (c = r ? K(s, p) : d[u]) > -1 && (s[c] = !(a[c] = p))
                    }
        ...
        function _(t) {
            for (var e, i, s, n = t.length, o = y.relative[t[0].type], r = o || y.relative[" "], a = o ? 1 : 0, l = d(function(t) { return t === e }, r, !0), h = d(function(t) { return K(e, t) > -1 }, r, !0), c = [function(t, i, s) { var n = !o && (s || i !== S) || ((e = i).nodeType ? l(t, i, s) : h(t, i, s)); return e = null, n }]; n > a; a++)
                if (i = y.relative[t[a].type]) c = [d(f(c), i)];
                else {
                    if ((i = y.filter[t[a].type].apply(null, t[a].matches))[N]) { for (s = ++a; n > s && !y.relative[t[s].type]; s++); return g(a > 1 && f(c), a > 1 && p(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(rt, "$1"), i, s > a && _(t.slice(a, s)), n > s && _(t = t.slice(s)), n > s && p(t)) }
                    c.push(i)
                }
            return f(c)
        }
        var v, b, y, w, x, T, k, C, S, P, E, A, D, O, R, $, M, I, L, N = "sizzle" + 1 * new Date,
            z = t.document,
            j = 0,
            F = 0,
            H = i(),
            X = i(),
            W = i(),
            Y = function(t, e) { return t === e && (E = !0), 0 },
            B = 1 << 31,
            q = {}.hasOwnProperty,
            V = [],
            U = V.pop,
            ...
            ct = new RegExp(nt),
            ut = new RegExp("^" + it + "$"),
            pt = { ID: new RegExp("^#(" + et + ")"), CLASS: new RegExp("^\\.(" + et + ")"), TAG: new RegExp("^(" + et.replace("w", "w*") + ")"), ATTR: new RegExp("^" + st), PSEUDO: new RegExp("^" + nt), CHILD: new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + tt + "*(even|odd|(([+-]|)(\\d*)n|)" + tt + "*(?:([+-]|)" + tt + "*(\\d+)|))" + tt + "*\\)|)", "i"), bool: new RegExp("^(?:" + J + ")$", "i"), needsContext: new RegExp("^" + tt + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + tt + "*((?:-\\d)?\\d*)" + tt + "*\\)|)(?=[^-]|$)", "i") },
            ...
            wt = function() { A() };
        try { G.apply(V = Z.call(z.childNodes), z.childNodes), V[z.childNodes.length].nodeType } catch (t) {
            G = {
                apply: V.length ? function(t, e) { Q.apply(t, Z.call(e)) } : function(t, e) {
                    for (var i = t.length, s = 0; t[i++] = e[s++];);
                    t.length = i - 1
                }
            }
        }
        b = e.support = {}, x = e.isXML = function(t) { var e = t && (t.ownerDocument || t).documentElement; return !!e && "HTML" !== e.nodeName }, A = e.setDocument = function(t) {
            var e, i, s = t ? t.ownerDocument || t : z;
            return s !== D && 9 === s.nodeType && s.documentElement ? (D = s, O = s.documentElement, (i = s.defaultView) && i !== i.top && (i.addEventListener ? i.addEventListener("unload", wt, !1) : i.attachEvent && i.attachEvent("onunload", wt)), R = !x(s), b.attributes = n(function(t) { return t.className = "i", !t.getAttribute("className") }), b.getElementsByTagName = n(function(t) { return t.appendChild(s.createComment("")), !t.getElementsByTagName("*").length }), b.getElementsByClassName = mt.test(s.getElementsByClassName), b.getById = n(function(t) { return O.appendChild(t).id = N, !s.getElementsByName || !s.getElementsByName(N).length }), b.getById ? (y.find.ID = function(t, e) { if (void 0 !== e.getElementById && R) { var i = e.getElementById(t); return i && i.parentNode ? [i] : [] } }, y.filter.ID = function(t) { var e = t.replace(bt, yt); return function(t) { return t.getAttribute("id") === e } }) : (delete y.find.ID, y.filter.ID = function(t) { var e = t.replace(bt, yt); return function(t) { var i = void 0 !== t.getAttributeNode && t.getAttributeNode("id"); return i && i.value === e } }), y.find.TAG = b.getElementsByTagName ? function(t, e) { return void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t) : b.qsa ? e.querySelectorAll(t) : void 0 } : function(t, e) {
                var i, s = [],
                    n = 0,
                    o = e.getElementsByTagName(t);
                if ("*" === t) { for (; i = o[n++];) 1 === i.nodeType && s.push(i); return s }
                return o
            }, y.find.CLASS = b.getElementsByClassName && function(t, e) { return R ? e.getElementsByClassName(t) : void 0 }, M = [], $ = [], (b.qsa = mt.test(s.querySelectorAll)) && (n(function(t) { O.appendChild(t).innerHTML = "<a id='" + N + "'></a><select id='" + N + "-\f]' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && $.push("[*^$]=" + tt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || $.push("\\[" + tt + "*(?:value|" + J + ")"), t.querySelectorAll("[id~=" + N + "-]").length || $.push("~="), t.querySelectorAll(":checked").length || $.push(":checked"), t.querySelectorAll("a#" + N + "+*").length || $.push(".#.+[+~]") }), n(function(t) {
                ...
                if (e)
                    for (; e = e.parentNode;)
                        if (e === t) return !0;
                return !1
            }, Y = e ? function(t, e) { if (t === e) return E = !0, 0; var i = !t.compareDocumentPosition - !e.compareDocumentPosition; return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === s || t.ownerDocument === z && L(z, t) ? -1 : e === s || e.ownerDocument === z && L(z, e) ? 1 : P ? K(P, t) - K(P, e) : 0 : 4 & i ? -1 : 1) } : function(t, e) {
                if (t === e) return E = !0, 0;
                var i, n = 0,
                    o = t.parentNode,
                    a = e.parentNode,
            ...
            if ((t.ownerDocument || t) !== D && A(t), i = i.replace(ht, "='$1']"), !(!b.matchesSelector || !R || M && M.test(i) || $ && $.test(i))) try { var s = I.call(t, i); if (s || b.disconnectedMatch || t.document && 11 !== t.document.nodeType) return s } catch (t) {}
            ...
            var e, i = [],
                s = 0,
                n = 0;
            if (E = !b.detectDuplicates, P = !b.sortStable && t.slice(0), t.sort(Y), E) { for (; e = t[n++];) e === t[n] && (s = i.push(n)); for (; s--;) t.splice(i[s], 1) }
            return P = null, t
            ...
            filter: {
                ...
                CLASS: function(t) { var e = H[t + " "]; return e || (e = new RegExp("(^|" + tt + ")" + t + "(" + tt + "|$)")) && H(t, function(t) { return e.test("string" == typeof t.className && t.className || void 0 !== t.getAttribute && t.getAttribute("class") || "") }) },
                ...
                CHILD: function(t, e, i, s, n) {
                    ...
                    return 1 === s && 0 === n ? function(t) { return !!t.parentNode } : function(e, i, l) {
                        var h, c, u, p, d, f, m = o !== r ? "nextSibling" : "previousSibling",
                            g = e.parentNode,
                        ...
                        if (g) {
                            ...
                            if (f = [r ? g.firstChild : g.lastChild], r && v) {
                                for (d = (h = (c = g[N] || (g[N] = {}))[t] || [])[0] === j && h[1], p = h[0] === j && h[2], u = d && g.childNodes[d]; u = ++d && u && u[m] || (p = d = 0) || f.pop();)
                                    if (1 === u.nodeType && ++p && u === e) { c[t] = [j, d, p]; break }
                            } else if (v && (h = (e[N] || (e[N] = {}))[t]) && h[0] === j) p = h[1];
                            else
                                for (;
                                    (u = ++d && u && u[m] || (p = d = 0) || f.pop()) && ((a ? u.nodeName.toLowerCase() !== _ : 1 !== u.nodeType) || !++p || (v && ((u[N] || (u[N] = {}))[t] = [j, p]), u !== e)););
                            return (p -= n) === s || p % s == 0 && p / s >= 0
                        }
                    }
                },
                PSEUDO: function(t, i) { var n, o = y.pseudos[t] || y.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t); return o[N] ? o(i) : o.length > 1 ? (n = [t, t, "", i], y.setFilters.hasOwnProperty(t.toLowerCase()) ? s(function(t, e) { for (var s, n = o(t, i), r = n.length; r--;) s = K(t, n[r]), t[s] = !(e[s] = n[r]) }) : function(t) { return o(t, 0, n) }) : o }
            },
            pseudos: {
                not: s(function(t) {
                    var e = [],
                        i = [],
                        n = k(t.replace(rt, "$1"));
                    return n[N] ? s(function(t, e, i, s) { for (var o, r = n(t, null, s, []), a = t.length; a--;)(o = r[a]) && (t[a] = !(e[a] = o)) }) : function(t, s, o) { return e[0] = t, n(e, null, o, i), e[0] = null, !i.pop() }
                }),
        ...
        for (v in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }) y.pseudos[v] = a(v);
        ...
        return u.prototype = y.filters = y.pseudos, y.setFilters = new u, T = e.tokenize = function(t, i) {
            ...
            for (a = t, l = [], h = y.preFilter; a;) {
                ...
                for (r in y.filter) !(n = pt[r].exec(a)) || h[r] && !(n = h[r](n)) || (s = n.shift(), o.push({ value: s, type: r, matches: n }), a = a.slice(s.length));
                if (!s) break
            }
            ...
            var n, o = [],
                ...
                a = W[t + " "];
            if (!a) {
                for (i || (i = T(t)), n = i.length; n--;)(a = _(i[n]))[N] ? o.push(a) : r.push(a);
                (a = W(t, function(t, i) {
                    var n = i.length > 0,
                        o = t.length > 0,
                        r = function(s, r, a, l, h) {
                            var c, u, p, d = 0,
                                ...
                                x = b.length;
                            for (h && (S = r !== D && r); f !== x && null != (c = b[f]); f++) {
                                if (o && c) {
                                    for (u = 0; p = t[u++];)
                                        if (p(c, r, a)) { l.push(c); break }
                                    h && (j = w)
                                }
                                n && ((c = !p && c) && d--, s && g.push(c))
                            }
                            if (d += f, n && f !== d) {
                                for (u = 0; p = i[u++];) p(g, _, r, a);
                                if (s) {
                                    if (d > 0)
                                        for (; f--;) g[f] || _[f] || (_[f] = U.call(l));
                                    _ = m(_)
                                }
    ...
    var J = V.expr.match.needsContext,
        tt = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        et = /^.[^:#\[\.,]*$/;
    V.filter = function(t, e, i) { var s = e[0]; return i && (t = ":not(" + t + ")"), 1 === e.length && 1 === s.nodeType ? V.find.matchesSelector(s, t) ? [s] : [] : V.find.matches(t, V.grep(e, function(t) { return 1 === t.nodeType })) }, V.fn.extend({
        find: function(t) {
            var e, i = this.length,
                s = [],
                n = this;
        ...
        is: function(t) { return !!s(this, "string" == typeof t && J.test(t) ? V(t) : t || [], !1).length }
    });
    var it, st = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (V.fn.init = function(t, e) {
        ...
        if ("string" == typeof t) {
            ...
            if (i[1]) {
                if (e = e instanceof V ? e[0] : e, V.merge(this, V.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : q, !0)), tt.test(i[1]) && V.isPlainObject(e))
        ...
        closest: function(t, e) {
            for (var i, s = 0, n = this.length, o = [], r = J.test(t) || "string" != typeof t ? V(t, e || this.context) : 0; n > s; s++)
                for (i = this[s]; i && i !== e; i = i.parentNode)
                    if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && V.find.matchesSelector(i, t))) { o.push(i); break }
            return this.pushStack(o.length > 1 ? V.unique(o) : o)
        },
        index: function(t) { return t ? "string" == typeof t ? H.call(V(t), this[0]) : H.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1 },
        add: function(t, e) { return this.pushStack(V.unique(V.merge(this.get(), V(t, e)))) },
        addBack: function(t) { return this.add(null == t ? this.prevObject : this.prevObject.filter(t)) }
    }), V.each({ parent: function(t) { var e = t.parentNode; return e && 11 !== e.nodeType ? e : null }, parents: function(t) { return V.dir(t, "parentNode") }, parentsUntil: function(t, e, i) { return V.dir(t, "parentNode", i) }, next: function(t) { return n(t, "nextSibling") }, prev: function(t) { return n(t, "previousSibling") }, nextAll: function(t) { return V.dir(t, "nextSibling") }, prevAll: function(t) { return V.dir(t, "previousSibling") }, nextUntil: function(t, e, i) { return V.dir(t, "nextSibling", i) }, prevUntil: function(t, e, i) { return V.dir(t, "previousSibling", i) }, siblings: function(t) { return V.sibling((t.parentNode || {}).firstChild, t) }, children: function(t) { return V.sibling(t.firstChild) }, contents: function(t) { return t.contentDocument || V.merge([], t.childNodes) } }, function(t, e) { V.fn[t] = function(i, s) { var n = V.map(this, e, i); return "Until" !== t.slice(-5) && (s = i), s && "string" == typeof s && (n = V.filter(s, n)), this.length > 1 && (ot[t] || V.unique(n), nt.test(t) && n.reverse()), this.pushStack(n) } });
    var rt = /\S+/g,
        at = {};
    V.Callbacks = function(t) {
        var e, i, s, n, o, r, a = [],
            l = !(t = "string" == typeof t ? at[t] || function(t) { var e = at[t] = {}; return V.each(t.match(rt) || [], function(t, i) { e[i] = !0 }), e }(t) : V.extend({}, t)).once && [],
            h = function(u) {
            ...
            c = {
                add: function() { if (a) { var i = a.length;! function e(i) { V.each(i, function(i, s) { var n = V.type(s); "function" === n ? t.unique && c.has(s) || a.push(s) : s && s.length && "string" !== n && e(s) }) }(arguments), s ? o = a.length : e && (n = i, h(e)) } return this },
                remove: function() {
                    return a && V.each(arguments, function(t, e) {
                        for (var i;
                            (i = V.inArray(e, a, i)) > -1;) a.splice(i, 1), s && (o >= i && o--, r >= i && r--)
                    }), this
                },
                has: function(t) { return t ? V.inArray(t, a) > -1 : !(!a || !a.length) },
        ...
        Deferred: function(t) {
            var e = [
                ...
                s = {
                    ...
                    promise: function(t) { return null != t ? V.extend(t, s) : s }
                },
                n = {};
        ...
        when: function(t) {
            ...
            if (r > 1)
                for (e = new Array(r), i = new Array(r), s = new Array(r); r > n; n++) o[n] && V.isFunction(o[n].promise) ? o[n].promise().done(h(n, s, o)).fail(l.reject).progress(h(n, i, e)) : --a;
            return a || l.resolveWith(s, o), l.promise()
        }
    });
    var lt;
    V.fn.ready = function(t) { return V.ready.promise().done(t), this }, V.extend({
        isReady: !1,
        readyWait: 1,
        holdReady: function(t) { t ? V.readyWait++ : V.ready(!0) },
        ready: function(t) {
    ...
    }), V.ready.promise = function(e) { return lt || (lt = V.Deferred(), "complete" === q.readyState ? setTimeout(V.ready) : (q.addEventListener("DOMContentLoaded", o, !1), t.addEventListener("load", o, !1))), lt.promise(e) }, V.ready.promise();
    var ht = V.access = function(t, e, i, s, n, o, r) {
        var a = 0,
            l = t.length,
            h = null == i;
        if ("object" === V.type(i)) { n = !0; for (a in i) V.access(t, e, a, i[a], !0, o, r) } else if (void 0 !== s && (n = !0, V.isFunction(s) || (r = !0), h && (r ? (e.call(t, s), e = null) : (h = e, e = function(t, e, i) { return h.call(V(t), i) })), e))
            for (; l > a; a++) e(t[a], i, r ? s : s.call(t[a], a, e(t[a], i)));
        return n ? t : h ? e.call(t) : l ? e(t[0], i) : o
    };
    V.acceptData = function(t) { return 1 === t.nodeType || 9 === t.nodeType || !+t.nodeType }, r.uid = 1, r.accepts = V.acceptData, r.prototype = {
        key: function(t) {
            if (!r.accepts(t)) return 0;
            var e = {},
                i = t[this.expando];
            if (!i) { i = r.uid++; try { e[this.expando] = { value: i }, Object.defineProperties(t, e) } catch (s) { e[this.expando] = i, V.extend(t, e) } }
        ...
        set: function(t, e, i) {
            ...
            else if (V.isEmptyObject(o)) V.extend(this.cache[n], e);
            else
                for (s in e) o[s] = e[s];
            return o
        },
        get: function(t, e) { var i = this.cache[this.key(t)]; return void 0 === e ? i : i[e] },
        access: function(t, e, i) { var s; return void 0 === e || e && "string" == typeof e && void 0 === i ? void 0 !== (s = this.get(t, e)) ? s : this.get(t, V.camelCase(e)) : (this.set(t, e, i), void 0 !== i ? i : e) },
        remove: function(t, e) {
            var i, s, n, o = this.key(t),
                r = this.cache[o];
            if (void 0 === e) this.cache[o] = {};
            else { V.isArray(e) ? s = e.concat(e.map(V.camelCase)) : (n = V.camelCase(e), e in r ? s = [e, n] : (s = n, s = s in r ? [s] : s.match(rt) || [])), i = s.length; for (; i--;) delete r[s[i]] }
        },
        hasData: function(t) { return !V.isEmptyObject(this.cache[t[this.expando]] || {}) },
    ...
    var ct = new r,
        ...
        pt = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
        dt = /([A-Z])/g;
    V.extend({ hasData: function(t) { return ut.hasData(t) || ct.hasData(t) }, data: function(t, e, i) { return ut.access(t, e, i) }, removeData: function(t, e) { ut.remove(t, e) }, _data: function(t, e, i) { return ct.access(t, e, i) }, _removeData: function(t, e) { ct.remove(t, e) } }), V.fn.extend({
        data: function(t, e) {
            var i, s, n, o = this[0],
                r = o && o.attributes;
            if (void 0 === t) {
                if (this.length && (n = ut.get(o), 1 === o.nodeType && !ct.get(o, "hasDataAttrs"))) {
                    for (i = r.length; i--;) r[i] && 0 === (s = r[i].name).indexOf("data-") && (s = V.camelCase(s.slice(5)), a(o, s, n[s]));
                    ct.set(o, "hasDataAttrs", !0)
                }
                return n
            }
            return "object" == typeof t ? this.each(function() { ut.set(this, t) }) : ht(this, function(e) {
                var i, s = V.camelCase(t);
        ...
        queue: function(t, e, i) { var s; return t ? (e = (e || "fx") + "queue", s = ct.get(t, e), i && (!s || V.isArray(i) ? s = ct.access(t, e, V.makeArray(i)) : s.push(i)), s || []) : void 0 },
        dequeue: function(t, e) {
            ...
            var i = V.queue(t, e),
                ...
                n = i.shift(),
                o = V._queueHooks(t, e);
            "inprogress" === n && (n = i.shift(), s--), n && ("fx" === e && i.unshift("inprogress"), delete o.stop, n.call(t, function() { V.dequeue(t, e) }, o)), !s && o && o.empty.fire()
        },
        _queueHooks: function(t, e) { var i = e + "queueHooks"; return ct.get(t, i) || ct.access(t, i, { empty: V.Callbacks("once memory").add(function() { ct.remove(t, [e + "queue", i]) }) }) }
    }), V.fn.extend({
        queue: function(t, e) {
            var i = 2;
        ...
        dequeue: function(t) { return this.each(function() { V.dequeue(this, t) }) },
    ...
    var ft = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        gt = function(t, e) { return t = e || t, "none" === V.css(t, "display") || !V.contains(t.ownerDocument, t) },
        _t = /^(?:checkbox|radio)$/i;
    ! function() {
    ...
    V.event = {
        ...
        add: function(t, e, i, s, n) {
            var o, r, a, l, h, c, u, p, d, f, m, g = ct.get(t);
            if (g)
                for (i.handler && (o = i, i = o.handler, n = o.selector), i.guid || (i.guid = V.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function(e) { return typeof V !== vt && V.event.triggered !== e.type ? V.event.dispatch.apply(t, arguments) : void 0 }), h = (e = (e || "").match(rt) || [""]).length; h--;) a = xt.exec(e[h]) || [], d = m = a[1], f = (a[2] || "").split(".").sort(), d && (u = V.event.special[d] || {}, d = (n ? u.delegateType : u.bindType) || d, u = V.event.special[d] || {}, c = V.extend({ type: d, origType: m, data: s, handler: i, guid: i.guid, selector: n, needsContext: n && V.expr.match.needsContext.test(n), namespace: f.join(".") }, o), (p = l[d]) || (p = l[d] = [], p.delegateCount = 0, u.setup && !1 !== u.setup.call(t, s, f, r) || t.addEventListener && t.addEventListener(d, r, !1)), u.add && (u.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), n ? p.splice(p.delegateCount++, 0, c) : p.push(c), V.event.global[d] = !0)
        },
        remove: function(t, e, i, s, n) {
            var o, r, a, l, h, c, u, p, d, f, m, g = ct.hasData(t) && ct.get(t);
            if (g && (l = g.events)) {
                for (h = (e = (e || "").match(rt) || [""]).length; h--;)
                    if (a = xt.exec(e[h]) || [], d = m = a[1], f = (a[2] || "").split(".").sort(), d) {
                        for (u = V.event.special[d] || {}, p = l[d = (s ? u.delegateType : u.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = p.length; o--;) c = p[o], !n && m !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || s && s !== c.selector && ("**" !== s || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, u.remove && u.remove.call(t, c));
                        r && !p.length && (u.teardown && !1 !== u.teardown.call(t, f, g.handle) || V.removeEvent(t, d, g.handle), delete l[d])
                    } else
                        for (d in l) V.event.remove(t, d + e[h], i, s, !0);
                V.isEmptyObject(l) && (delete g.handle, ct.remove(t, "events"))
            }
        },
        trigger: function(e, i, s, n) {
            var o, r, a, l, h, c, u, p = [s || q],
                d = Y.call(e, "type") ? e.type : e,
                f = Y.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = a = s = s || q, 3 !== s.nodeType && 8 !== s.nodeType && !wt.test(d + V.event.triggered) && (d.indexOf(".") >= 0 && (f = d.split("."), d = f.shift(), f.sort()), h = d.indexOf(":") < 0 && "on" + d, e = e[V.expando] ? e : new V.Event(d, "object" == typeof e && e), e.isTrigger = n ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = s), i = null == i ? [e] : V.makeArray(i, [e]), u = V.event.special[d] || {}, n || !u.trigger || !1 !== u.trigger.apply(s, i))) {
                if (!n && !u.noBubble && !V.isWindow(s)) {
                    for (l = u.delegateType || d, wt.test(l + d) || (r = r.parentNode); r; r = r.parentNode) p.push(r), a = r;
                    a === (s.ownerDocument || q) && p.push(a.defaultView || a.parentWindow || t)
                }
                for (o = 0;
                    (r = p[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l : u.bindType || d, (c = (ct.get(r, "events") || {})[e.type] && ct.get(r, "handle")) && c.apply(r, i), (c = h && r[h]) && c.apply && V.acceptData(r) && (e.result = c.apply(r, i), !1 === e.result && e.preventDefault());
        ...
        dispatch: function(t) {
            ...
            if (a[0] = t, t.delegateTarget = this, !h.preDispatch || !1 !== h.preDispatch.call(this, t)) {
                for (r = V.event.handlers.call(this, t, l), e = 0;
                    (n = r[e++]) && !t.isPropagationStopped();)
                    for (t.currentTarget = n.elem, i = 0;
                        (o = n.handlers[i++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(o.namespace)) && (t.handleObj = o, t.data = o.data, void 0 !== (s = ((V.event.special[o.origType] || {}).handle || o.handler).apply(n.elem, a)) && !1 === (t.result = s) && (t.preventDefault(), t.stopPropagation()));
            ...
            if (a && l.nodeType && (!t.button || "click" !== t.type))
                for (; l !== this; l = l.parentNode || this)
                    if (!0 !== l.disabled || "click" !== t.type) {
                        for (s = [], i = 0; a > i; i++) o = e[i], n = o.selector + " ", void 0 === s[n] && (s[n] = o.needsContext ? V(n, this).index(l) >= 0 : V.find(n, this, null, [l]).length), s[n] && s.push(o);
        ...
        fix: function(t) {
            ...
            var e, i, s, n = t.type,
                o = t,
                r = this.fixHooks[n];
            for (r || (this.fixHooks[n] = r = yt.test(n) ? this.mouseHooks : bt.test(n) ? this.keyHooks : {}), s = r.props ? this.props.concat(r.props) : this.props, t = new V.Event(o), e = s.length; e--;) i = s[e], t[i] = o[i];
            return t.target || (t.target = q), 3 === t.target.nodeType && (t.target = t.target.parentNode), r.filter ? r.filter(t, o) : t
        },
        special: { load: { noBubble: !0 }, focus: { trigger: function() { return this !== c() && this.focus ? (this.focus(), !1) : void 0 }, delegateType: "focusin" }, blur: { trigger: function() { return this === c() && this.blur ? (this.blur(), !1) : void 0 }, delegateType: "focusout" }, click: { trigger: function() { return "checkbox" === this.type && this.click && V.nodeName(this, "input") ? (this.click(), !1) : void 0 }, _default: function(t) { return V.nodeName(t.target, "a") } }, beforeunload: { postDispatch: function(t) { void 0 !== t.result && t.originalEvent && (t.originalEvent.returnValue = t.result) } } },
        simulate: function(t, e, i, s) {
            var n = V.extend(new V.Event, i, { type: t, isSimulated: !0, originalEvent: {} });
            s ? V.event.trigger(n, null, e) : V.event.dispatch.call(e, n), n.isDefaultPrevented() && i.preventDefault()
        }
    }, V.removeEvent = function(t, e, i) { t.removeEventListener && t.removeEventListener(e, i, !1) }, V.Event = function(t, e) { return this instanceof V.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? l : h) : this.type = t, e && V.extend(this, e), this.timeStamp = t && t.timeStamp || V.now(), void(this[V.expando] = !0)) : new V.Event(t, e) }, V.Event.prototype = {
    ...
    }), B.focusinBubbles || V.each({ focus: "focusin", blur: "focusout" }, function(t, e) {
        var i = function(t) { V.event.simulate(e, t.target, V.event.fix(t), !0) };
        V.event.special[e] = {
            setup: function() {
        ...
        on: function(t, e, i, s, n) {
            ...
            return 1 === n && (o = s, s = function(t) { return V().off(t), o.apply(this, arguments) }, s.guid = o.guid || (o.guid = V.guid++)), this.each(function() { V.event.add(this, t, s, i, e) })
        },
        one: function(t, e, i, s) { return this.on(t, e, i, s, 1) },
        off: function(t, e, i) { var s, n; if (t && t.preventDefault && t.handleObj) return s = t.handleObj, V(t.delegateTarget).off(s.namespace ? s.origType + "." + s.namespace : s.origType, s.selector, s.handler), this; if ("object" == typeof t) { for (n in t) this.off(n, e, t[n]); return this } return (!1 === e || "function" == typeof e) && (i = e, e = void 0), !1 === i && (i = h), this.each(function() { V.event.remove(this, t, i, e) }) },
        trigger: function(t, e) { return this.each(function() { V.event.trigger(t, e, this) }) },
        triggerHandler: function(t, e) { var i = this[0]; return i ? V.event.trigger(t, e, i, !0) : void 0 }
    });
    var Tt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
        ...
        At = /^true\/(.*)/,
        Dt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        Ot = { option: [1, "<select multiple='multiple'>", "</select>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""] };
    Ot.optgroup = Ot.option, Ot.tbody = Ot.tfoot = Ot.colgroup = Ot.caption = Ot.thead, Ot.th = Ot.td, V.extend({
        clone: function(t, e, i) {
            ...
            if (!(B.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || V.isXMLDoc(t)))
                for (r = g(a), o = g(t), s = 0, n = o.length; n > s; s++) _(o[s], r[s]);
            if (e)
                if (i)
        ...
        buildFragment: function(t, e, i, s) {
            for (var n, o, r, a, l, h, c = e.createDocumentFragment(), u = [], p = 0, d = t.length; d > p; p++)
                if ((n = t[p]) || 0 === n)
                    if ("object" === V.type(n)) V.merge(u, n.nodeType ? [n] : n);
                    else if (Ct.test(n)) {
                for (o = o || c.appendChild(e.createElement("div")), r = (kt.exec(n) || ["", ""])[1].toLowerCase(), a = Ot[r] || Ot._default, o.innerHTML = a[1] + n.replace(Tt, "<$1></$2>") + a[2], h = a[0]; h--;) o = o.lastChild;
                V.merge(u, o.childNodes), (o = c.firstChild).textContent = ""
            } else u.push(e.createTextNode(n));
            for (c.textContent = "", p = 0; n = u[p++];)
                if ((!s || -1 === V.inArray(n, s)) && (l = V.contains(n.ownerDocument, n), o = g(c.appendChild(n), "script"), l && f(o), i))
                    for (h = 0; n = o[h++];) Et.test(n.type || "") && i.push(n);
            return c
        },
        cleanData: function(t) {
            for (var e, i, s, n, o = V.event.special, r = 0; void 0 !== (i = t[r]); r++) {
                if (V.acceptData(i) && (n = i[ct.expando]) && (e = ct.cache[n])) {
                    if (e.events)
                        for (s in e.events) o[s] ? V.event.remove(i, s) : V.removeEvent(i, s, e.handle);
        ...
        remove: function(t, e) { for (var i, s = t ? V.filter(t, this) : this, n = 0; null != (i = s[n]); n++) e || 1 !== i.nodeType || V.cleanData(g(i)), i.parentNode && (e && V.contains(i.ownerDocument, i) && f(g(i, "script")), i.parentNode.removeChild(i)); return this },
        empty: function() { for (var t, e = 0; null != (t = this[e]); e++) 1 === t.nodeType && (V.cleanData(g(t, !1)), t.textContent = ""); return this },
        clone: function(t, e) { return t = null != t && t, e = null == e ? t : e, this.map(function() { return V.clone(this, t, e) }) },
        html: function(t) {
            return ht(this, function(t) {
                var e = this[0] || {},
                    i = 0,
                ...
                if ("string" == typeof t && !St.test(t) && !Ot[(kt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = t.replace(Tt, "<$1></$2>");
                    try {
                        for (; s > i; i++) 1 === (e = this[i] || {}).nodeType && (V.cleanData(g(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() { var t = arguments[0]; return this.domManip(arguments, function(e) { t = this.parentNode, V.cleanData(g(this)), t && t.replaceChild(e, this) }), t && (t.length || t.nodeType) ? this : this.remove() },
        ...
        domManip: function(t, e) {
            ...
            if (h && (i = V.buildFragment(t, this[0].ownerDocument, !1, this), s = i.firstChild, 1 === i.childNodes.length && (i = s), s)) {
                for (o = (n = V.map(g(i, "script"), p)).length; h > l; l++) r = i, l !== u && (r = V.clone(r, !0, !0), o && V.merge(n, g(r, "script"))), e.call(this[l], r, l);
                if (o)
                    for (a = n[n.length - 1].ownerDocument, V.map(n, d), l = 0; o > l; l++) r = n[l], Et.test(r.type || "") && !ct.access(r, "globalEval") && V.contains(a, r) && (r.src ? V._evalUrl && V._evalUrl(r.src) : V.globalEval(r.textContent.replace(Dt, "")))
            }
            return this
        }
    }), V.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function(t, e) { V.fn[t] = function(t) { for (var i, s = [], n = V(t), o = n.length - 1, r = 0; o >= r; r++) i = r === o ? this : this.clone(!0), V(n[r])[e](i), F.apply(s, i.get()); return this.pushStack(s) } });
    var Rt, $t = {},
        Mt = /^margin/,
        It = new RegExp("^(" + ft + ")(?!px)[a-z%]+$", "i"),
        Lt = function(e) { return e.ownerDocument.defaultView.opener ? e.ownerDocument.defaultView.getComputedStyle(e, null) : t.getComputedStyle(e, null) };
    ! function() {
        function e() {
    ...
    var Wt, Yt, Bt = /^(?:toggle|show|hide)$/,
        ...
        Ut = [function(t, e, i) {
            ...
            if (V.isEmptyObject(u)) "inline" === ("none" === h ? b(t.nodeName) : h) && (p.display = h);
            else {
                f ? "hidden" in f && (d = f.hidden) : f = ct.access(t, "fxshow", {}), o && (f.hidden = !d), d ? V(t).show() : c.done(function() { V(t).hide() }), c.done(function() {
                    var e;
                    ct.remove(t, "fxshow");
                    for (e in u) V.style(t, e, u[e])
                });
                for (s in u) r = D(d ? f[s] : 0, s, c), s in f || (f[s] = r.start, d && (r.end = r.start, r.start = "width" === s || "height" === s ? 1 : 0))
            }
        }],
        Qt = {
            "*": [function(t, e) {
    ...
    V.Animation = V.extend(O, { tweener: function(t, e) { V.isFunction(t) ? (e = t, t = ["*"]) : t = t.split(" "); for (var i, s = 0, n = t.length; n > s; s++) i = t[s], Qt[i] = Qt[i] || [], Qt[i].unshift(e) }, prefilter: function(t, e) { e ? Ut.unshift(t) : Ut.push(t) } }), V.speed = function(t, e, i) { var s = t && "object" == typeof t ? V.extend({}, t) : { complete: i || !i && e || V.isFunction(t) && t, duration: t, easing: i && e || e && !V.isFunction(e) && e }; return s.duration = V.fx.off ? 0 : "number" == typeof s.duration ? s.duration : s.duration in V.fx.speeds ? V.fx.speeds[s.duration] : V.fx.speeds._default, (null == s.queue || !0 === s.queue) && (s.queue = "fx"), s.old = s.complete, s.complete = function() { V.isFunction(s.old) && s.old.call(this), s.queue && V.dequeue(this, s.queue) }, s }, V.fn.extend({
            ...
            stop: function(t, e, i) {
                ...
                return "string" != typeof t && (i = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function() {
                    ...
                    if (n) r[n] && r[n].stop && s(r[n]);
                        ...
                        for (n in r) r[n] && r[n].stop && Vt.test(n) && s(r[n]);
            ...
            var i = V.fn[e];
            V.fn[e] = function(t, s, n) { return null == t || "boolean" == typeof t ? i.apply(this, arguments) : this.animate(A(e, !0), t, s, n) }
        }), V.each({ slideDown: A("show"), slideUp: A("hide"), slideToggle: A("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function(t, e) { V.fn[t] = function(t, i, s) { return this.animate(e, t, i, s) } }), V.timers = [], V.fx.tick = function() {
            var t, e = 0,
                i = V.timers;
            for (Wt = V.now(); e < i.length; e++)(t = i[e])() || i[e] !== t || i.splice(e--, 1);
            i.length || V.fx.stop(), Wt = void 0
        }, V.fx.timer = function(t) { V.timers.push(t), t() ? V.fx.start() : V.timers.pop() }, V.fx.interval = 13, V.fx.start = function() { Yt || (Yt = setInterval(V.fx.tick, V.fx.interval)) }, V.fx.stop = function() { clearInterval(Yt), Yt = null }, V.fx.speeds = { slow: 600, fast: 200, _default: 400 }, V.fn.delay = function(t, e) {
    ...
    var Gt, Zt = V.expr.attrHandle;
    V.fn.extend({ attr: function(t, e) { return ht(this, V.attr, t, e, arguments.length > 1) }, removeAttr: function(t) { return this.each(function() { V.removeAttr(this, t) }) } }), V.extend({
        ...
        removeAttr: function(t, e) {
            var i, s, n = 0,
                o = e && e.match(rt);
            if (o && 1 === t.nodeType)
                for (; i = o[n++];) s = V.propFix[i] || i, V.expr.match.bool.test(i) && (t[s] = !1), t.removeAttribute(i)
        },
        attrHooks: { type: { set: function(t, e) { if (!B.radioValue && "radio" === e && V.nodeName(t, "input")) { var i = t.value; return t.setAttribute("type", e), i && (t.value = i), e } } } }
    }), Gt = { set: function(t, e, i) { return !1 === e ? V.removeAttr(t, i) : t.setAttribute(i, i), i } }, V.each(V.expr.match.bool.source.match(/\w+/g), function(t, e) {
        var i = Zt[e] || V.find.attr;
        Zt[e] = function(t, e, s) { var n, o; return s || (o = Zt[e], Zt[e] = n, n = null != i(t, e, s) ? e.toLowerCase() : null, Zt[e] = o), n }
    });
    var Kt = /^(?:input|select|textarea|button)$/i;
    V.fn.extend({ prop: function(t, e) { return ht(this, V.prop, t, e, arguments.length > 1) }, removeProp: function(t) { return this.each(function() { delete this[V.propFix[t] || t] }) } }), V.extend({ propFix: { for: "htmlFor", class: "className" }, prop: function(t, e, i) { var s, n, o = t.nodeType; if (t && 3 !== o && 8 !== o && 2 !== o) return (1 !== o || !V.isXMLDoc(t)) && (e = V.propFix[e] || e, n = V.propHooks[e]), void 0 !== i ? n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : t[e] = i : n && "get" in n && null !== (s = n.get(t, e)) ? s : t[e] }, propHooks: { tabIndex: { get: function(t) { return t.hasAttribute("tabindex") || Kt.test(t.nodeName) || t.href ? t.tabIndex : -1 } } } }), B.optSelected || (V.propHooks.selected = { get: function(t) { var e = t.parentNode; return e && e.parentNode && e.parentNode.selectedIndex, null } }), V.each(["tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap", "frameBorder", "contentEditable"], function() { V.propFix[this.toLowerCase()] = this });
    var Jt = /[\t\r\n\f]/g;
    V.fn.extend({
        addClass: function(t) {
            var e, i, s, n, o, r, a = "string" == typeof t && t,
                l = 0,
                h = this.length;
            if (V.isFunction(t)) return this.each(function(e) { V(this).addClass(t.call(this, e, this.className)) });
            if (a)
        ...
        removeClass: function(t) {
            var e, i, s, n, o, r, a = 0 === arguments.length || "string" == typeof t && t,
                l = 0,
                h = this.length;
            if (V.isFunction(t)) return this.each(function(e) { V(this).removeClass(t.call(this, e, this.className)) });
            if (a)
                for (e = (t || "").match(rt) || []; h > l; l++)
                    if (i = this[l], s = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Jt, " ") : "")) {
                        for (o = 0; n = e[o++];)
        ...
        toggleClass: function(t, e) {
            var i = typeof t;
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(V.isFunction(t) ? function(i) { V(this).toggleClass(t.call(this, i, this.className, e), e) } : function() {
                if ("string" === i)
                    for (var e, s = 0, n = V(this), o = t.match(rt) || []; e = o[s++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
    ...
    V.fn.extend({
        val: function(t) {
            ...
            return arguments.length ? (s = V.isFunction(t), this.each(function(i) {
                var n;
                1 === this.nodeType && (null == (n = s ? t.call(this, i, V(this).val()) : t) ? n = "" : "number" == typeof n ? n += "" : V.isArray(n) && (n = V.map(n, function(t) { return null == t ? "" : t + "" })), (e = V.valHooks[this.type] || V.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, n, "value") || (this.value = n))
        ...
        valHooks: {
            option: { get: function(t) { var e = V.find.attr(t, "value"); return null != e ? e : V.trim(V.text(t)) } },
            select: {
                get: function(t) {
                ...
                set: function(t, e) { for (var i, s, n = t.options, o = V.makeArray(e), r = n.length; r--;) s = n[r], (s.selected = V.inArray(s.value, o) >= 0) && (i = !0); return i || (t.selectedIndex = -1), o }
            }
        }
    }), V.each(["radio", "checkbox"], function() { V.valHooks[this] = { set: function(t, e) { return V.isArray(e) ? t.checked = V.inArray(V(t).val(), e) >= 0 : void 0 } }, B.checkOn || (V.valHooks[this].get = function(t) { return null === t.getAttribute("value") ? "on" : t.value }) }), V.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function(t, e) { V.fn[e] = function(t, i) { return arguments.length > 0 ? this.on(e, null, t, i) : this.trigger(e) } }), V.fn.extend({ hover: function(t, e) { return this.mouseenter(t).mouseleave(e || t) }, bind: function(t, e, i) { return this.on(t, null, e, i) }, unbind: function(t, e) { return this.off(t, null, e) }, delegate: function(t, e, i, s) { return this.on(e, t, i, s) }, undelegate: function(t, e, i) { return 1 === arguments.length ? this.off(t, "**") : this.off(e, t || "**", i) } });
    var ee = V.now(),
        ie = /\?/;
    V.parseJSON = function(t) { return JSON.parse(t + "") }, V.parseXML = function(t) { var e, i; if (!t || "string" != typeof t) return null; try { i = new DOMParser, e = i.parseFromString(t, "text/xml") } catch (t) { e = void 0 } return (!e || e.getElementsByTagName("parsererror").length) && V.error("Invalid XML: " + t), e };
    var se = /#.*$/,
        ne = /([?&])_=[^&]*/,
        oe = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        re = /^(?:GET|HEAD)$/,
    ...
    V.extend({
        ...
        ajax: function(t, e) {
            ...
            var s, n, o, r, a, l, h, c, u = V.ajaxSetup({}, e),
                p = u.context || u,
                ...
                w = {
                    ...
                    setRequestHeader: function(t, e) { var i = t.toLowerCase(); return b || (t = v[i] = v[i] || t, _[t] = e), this },
            ...
            if (s = $(ce, u, e, w)) {
                w.readyState = 1, h && d.trigger("ajaxSend", [w, u]), u.async && u.timeout > 0 && (a = setTimeout(function() { w.abort("timeout") }, u.timeout));
                try { b = 1, s.send(_, i) } catch (t) {
                    if (!(2 > b)) throw t;
                    i(-1, t)
                }
        ...
        getJSON: function(t, e, i) { return V.get(t, e, i, "json") },
        getScript: function(t, e) { return V.get(t, void 0, e, "script") }
    }), V.each(["get", "post"], function(t, e) { V[e] = function(t, i, s, n) { return V.isFunction(i) && (n = n || s, s = i, i = void 0), V.ajax({ url: t, type: e, dataType: n, data: i, success: s }) } }), V._evalUrl = function(t) { return V.ajax({ url: t, type: "GET", dataType: "script", async: !1, global: !1, throws: !0 }) }, V.fn.extend({
        wrapAll: function(t) { var e; return V.isFunction(t) ? this.each(function(e) { V(this).wrapAll(t.call(this, e)) }) : (this[0] && (e = V(t, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && e.insertBefore(this[0]), e.map(function() { for (var t = this; t.firstElementChild;) t = t.firstElementChild; return t }).append(this)), this) },
        wrapInner: function(t) {
            return this.each(V.isFunction(t) ? function(e) { V(this).wrapInner(t.call(this, e)) } : function() {
                var e = V(this),
                    i = e.contents();
                i.length ? i.wrapAll(t) : e.append(t)
            })
        },
        wrap: function(t) { var e = V.isFunction(t); return this.each(function(i) { V(this).wrapAll(e ? t.call(this, i) : t) }) },
        unwrap: function() { return this.parent().each(function() { V.nodeName(this, "body") || V(this).replaceWith(this.childNodes) }).end() }
    }), V.expr.filters.hidden = function(t) { return t.offsetWidth <= 0 && t.offsetHeight <= 0 }, V.expr.filters.visible = function(t) { return !V.expr.filters.hidden(t) };
    var fe = /%20/g,
        me = /\[\]$/,
        ge = /\r?\n/g,
    ...
    V.param = function(t, e) {
        var i, s = [],
            n = function(t, e) { e = V.isFunction(e) ? e() : null == e ? "" : e, s[s.length] = encodeURIComponent(t) + "=" + encodeURIComponent(e) };
        if (void 0 === e && (e = V.ajaxSettings && V.ajaxSettings.traditional), V.isArray(t) || t.jquery && !V.isPlainObject(t)) V.each(t, function() { n(this.name, this.value) });
        else
            for (i in t) I(i, t[i], e, n);
    ...
    t.attachEvent && t.attachEvent("onunload", function() { for (var t in ye) ye[t]() }), B.cors = !!xe && "withCredentials" in xe, B.ajax = xe = !!xe, V.ajaxTransport(function(t) {
        var e;
    ...
    V.fn.load = function(t, e, i) {
        ...
        var s, n, o, r = this,
            a = t.indexOf(" ");
        return a >= 0 && (s = V.trim(t.slice(a)), t = t.slice(0, a)), V.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (n = "POST"), r.length > 0 && V.ajax({ url: t, type: n, dataType: "html", data: e }).done(function(t) { o = arguments, r.html(s ? V("<div>").append(V.parseHTML(t)).find(s) : t) }).complete(i && function(t, e) { r.each(i, o || [t.responseText, e, t]) }), this
    }, V.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function(t, e) { V.fn[e] = function(t) { return this.on(e, t) } }), V.expr.filters.animated = function(t) { return V.grep(V.timers, function(e) { return t === e.elem }).length };
    var Se = t.document.documentElement;
    V.offset = {
        setOffset: function(t, e, i) {
            var s, n, o, r, a, l, h = V.css(t, "position"),
                c = V(t),
                u = {};
        ...
        offset: function(t) {
            if (arguments.length) return void 0 === t ? this : this.each(function(e) { V.offset.setOffset(this, t, e) });
            var e, i, s = this[0],
                n = { top: 0, left: 0 },
                o = s && s.ownerDocument;
            return o ? (e = o.documentElement, V.contains(e, s) ? (typeof s.getBoundingClientRect !== vt && (n = s.getBoundingClientRect()), i = L(o), { top: n.top + i.pageYOffset - e.clientTop, left: n.left + i.pageXOffset - e.clientLeft }) : n) : void 0
        },
        position: function() {
            if (this[0]) {
                var t, e, i = this[0],
                    s = { top: 0, left: 0 };
                return "fixed" === V.css(i, "position") ? e = i.getBoundingClientRect() : (t = this.offsetParent(), e = this.offset(), V.nodeName(t[0], "html") || (s = t.offset()), s.top += V.css(t[0], "borderTopWidth", !0), s.left += V.css(t[0], "borderLeftWidth", !0)), { top: e.top - s.top - V.css(i, "marginTop", !0), left: e.left - s.left - V.css(i, "marginLeft", !0) }
            }
        },
        offsetParent: function() { return this.map(function() { for (var t = this.offsetParent || Se; t && !V.nodeName(t, "html") && "static" === V.css(t, "position");) t = t.offsetParent; return t || Se }) }
    }), V.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(e, i) {
        var s = "pageYOffset" === i;
        V.fn[e] = function(n) { return ht(this, function(e, n, o) { var r = L(e); return void 0 === o ? r ? r[i] : e[n] : void(r ? r.scrollTo(s ? t.pageXOffset : o, s ? o : t.pageYOffset) : e[n] = o) }, e, n, arguments.length, null) }
    }), V.each(["top", "left"], function(t, e) { V.cssHooks[e] = w(B.pixelPosition, function(t, i) { return i ? (i = y(t, e), It.test(i) ? V(t).position()[e] + "px" : i) : void 0 }) }), V.each({ Height: "height", Width: "width" }, function(t, e) {
        V.each({ padding: "inner" + t, content: e, "": "outer" + t }, function(i, s) {
            V.fn[s] = function(s, n) {
                var o = arguments.length && (i || "boolean" != typeof s),
                    r = i || (!0 === s || !0 === n ? "margin" : "border");
                return ht(this, function(e, i, s) { var n; return V.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (n = e.documentElement, Math.max(e.body["scroll" + t], n["scroll" + t], e.body["offset" + t], n["offset" + t], n["client" + t])) : void 0 === s ? V.css(e, i, r) : V.style(e, i, s, r) }, e, o ? s : void 0, o, null)
            }
        })
    }), V.fn.size = function() { return this.length }, V.fn.andSelf = V.fn.addBack, "function" == typeof define && define.amd && define("jquery", [], function() { return V });
    var Pe = t.jQuery,
        Ee = t.$;
    return V.noConflict = function(e) { return t.$ === V && (t.$ = Ee), e && t.jQuery === V && (t.jQuery = Pe), V }, typeof e === vt && (t.jQuery = t.$ = V), V
}),
function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports ? module.exports = t : t(jQuery) }(function(t) {
    ...
    function s(t, e) { return c.settings.adjustOldDeltas && "mousewheel" === t.type && e % 120 == 0 }
...
function t(e, i, s) {
        ...
        function s(t, e) {
            ...
            e.event.bind(e.ownerDocument, "selectionchange", function() { t.contains(function() { var t = window.getSelection ? window.getSelection() : document.getSelection ? document.getSelection() : ""; return 0 === t.toString().length ? null : t.getRangeAt(0).commonAncestorContainer }()) ? h = !0 : (h = !1, i()) }), e.event.bind(window, "mouseup", function() { h && (h = !1, i()) }), e.event.bind(window, "keyup", function() { h && (h = !1, i()) }), e.event.bind(window, "mousemove", function(e) {
                if (h) {
                    ...
                    c < p + 3 ? (l.left = -5, n.startScrolling(t, "x")) : c > d - 3 ? (l.left = 5, n.startScrolling(t, "x")) : l.left = 0, u < f + 3 ? (l.top = f + 3 - u < 5 ? -5 : -20, n.startScrolling(t, "y")) : u > m - 3 ? (l.top = u - m + 3 < 5 ? 5 : 20, n.startScrolling(t, "y")) : l.top = 0, 0 === l.top && 0 === l.left ? i() : s || (s = setInterval(function() { return o.get(t) ? (a(t, "top", t.scrollTop + l.top), a(t, "left", t.scrollLeft + l.left), void r(t)) : void clearInterval(s) }, 50))
                }
            })
        }
        var n = t("../../lib/helper"),
    ...
    16: [function(t, e, i) {
        ...
        function s(t, e, i, s) {
            ...
            function f() {!b && y && (y = !1, clearInterval(v), v = setInterval(function() { return o.get(t) && (_.x || _.y) ? Math.abs(_.x) < .01 && Math.abs(_.y) < .01 ? void clearInterval(v) : (n(30 * _.x, 30 * _.y), _.x *= .8, void(_.y *= .8)) : void clearInterval(v) }, 10)) }
            var m = {},
                g = 0,
                _ = {},
                v = null,
...
function() {
    ...
    if (s) {
        ...
        r.setAttribute("type", "text/javascript"), r.readyState ? r.onreadystatechange = function() { "loaded" != r.readyState && "complete" != r.readyState || (r.onreadystatechange = null, loadHtml5LightBox(e)) } : r.onload = function() { loadHtml5LightBox(e) }, r.setAttribute("src", e + "jquery.js"), o.appendChild(r)
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                var s = function(t) {
                    ...
                    n = function(t, e, i) {
                        var s, n, o = t.cycle;
                        for (s in o) n = o[s], t[s] = "function" == typeof n ? n.call(e[i], i) : n[i % n.length];
                        delete t.cycle
                    },
                    o = function(t, e, s) { i.call(this, t, e, s), this._cycle = 0, this._yoyo = !0 === this.vars.yoyo, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._dirty = !0, this.render = o.prototype.render },
                    r = i._internals,
                    a = r.isSelector,
                    l = r.isArray,
                    h = o.prototype = i.to({}, .1, {}),
                    c = [];
                o.version = "1.18.2", h.constructor = o, h.kill()._gc = !1, o.killTweensOf = o.killDelayedCallsTo = i.killTweensOf, o.getTweensOf = i.getTweensOf, o.lagSmoothing = i.lagSmoothing, o.ticker = i.ticker, o.render = i.render, h.invalidate = function() { return this._yoyo = !0 === this.vars.yoyo, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._uncache(!0), i.prototype.invalidate.call(this) }, h.updateTo = function(t, e) {
                    var s, n = this.ratio,
                    ...
                    var s, n, o, a, l, h, c, u, p = this._dirty ? this.totalDuration() : this._totalDuration,
                        d = this._time,
                        f = this._totalTime,
                        m = this._cycle,
                        g = this._duration,
                    ...
                    if (t >= p - 1e-7 ? (this._totalTime = p, this._cycle = this._repeat, this._yoyo && 0 != (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = g, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (s = !0, n = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === g && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > _ || 0 >= t && t >= -1e-7 || 1e-10 === _ && "isPause" !== this.data) && _ !== t && (i = !0, _ > 1e-10 && (n = "onReverseComplete")), this._rawPrevTime = u = !e || t || _ === t ? t : 1e-10)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== f || 0 === g && _ > 0) && (n = "onReverseComplete", s = this._reversed), 0 > t && (this._active = !1, 0 === g && (this._initted || !this.vars.lazy || i) && (_ >= 0 && (i = !0), this._rawPrevTime = u = !e || t || _ === t ? t : 1e-10)), this._initted || (i = !0)) : (this._totalTime = this._time = t, 0 !== this._repeat && (a = g + this._repeatDelay, this._cycle = this._totalTime / a >> 0, 0 !== this._cycle && this._cycle === this._totalTime / a && this._cycle--, this._time = this._totalTime - this._cycle * a, this._yoyo && 0 != (1 & this._cycle) && (this._time = g - this._time), this._time > g ? this._time = g : this._time < 0 && (this._time = 0)), this._easeType ? (l = this._time / g, h = this._easeType, c = this._easePower, (1 === h || 3 === h && l >= .5) && (l = 1 - l), 3 === h && (l *= 2), 1 === c ? l *= l : 2 === c ? l *= l * l : 3 === c ? l *= l * l * l : 4 === c && (l *= l * l * l * l), 1 === h ? this.ratio = 1 - l : 2 === h ? this.ratio = l : this._time / g < .5 ? this.ratio = l / 2 : this.ratio = 1 - l / 2) : this.ratio = this._ease.getRatio(this._time / g)), d !== this._time || i || m !== this._cycle) {
                        ...
                        for (!1 !== this._lazy && (this._lazy = !1), this._active || !this._paused && this._time !== d && t >= 0 && (this._active = !0), 0 === f && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : n || (n = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === g) && (e || this._callback("onStart"))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s, o = o._next;
                ...
                }, o.to = function(t, e, i) { return new o(t, e, i) }, o.from = function(t, e, i) { return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, new o(t, e, i) }, o.fromTo = function(t, e, i, s) { return s.startAt = i, s.immediateRender = 0 != s.immediateRender && 0 != i.immediateRender, new o(t, e, s) }, o.staggerTo = o.allTo = function(t, e, r, h, u, p, d) {
                    h = h || 0;
                    var f, m, g, _, v = 0,
                        b = [],
                        y = function() { r.onComplete && r.onComplete.apply(r.onCompleteScope || this, arguments), u.apply(d || r.callbackScope || this, p || c) },
                        w = r.cycle,
                    ...
                    for (l(t) || ("string" == typeof t && (t = i.selector(t) || t), a(t) && (t = s(t))), t = t || [], 0 > h && ((t = s(t)).reverse(), h *= -1), f = t.length - 1, g = 0; f >= g; g++) {
                        ...
                        if (w && n(m, t, g), x) {
                            x = m.startAt = {};
                            for (_ in r.startAt) x[_] = r.startAt[_];
                            n(m.startAt, t, g)
                        }
                        m.delay = v + (m.delay || 0), g === f && u && (m.onComplete = y), b[g] = new o(t[g], e, m), v += h
                    }
                    return b
                }, o.staggerFrom = o.allFrom = function(t, e, i, s, n, r, a) { return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, o.staggerTo(t, e, i, s, n, r, a) }, o.staggerFromTo = o.allFromTo = function(t, e, i, s, n, r, a, l) { return s.startAt = i, s.immediateRender = 0 != s.immediateRender && 0 != i.immediateRender, o.staggerTo(t, e, s, n, r, a, l) }, o.delayedCall = function(t, e, i, s, n) { return new o(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: s, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, useFrames: n, overwrite: 0 }) }, o.set = function(t, e) { return new o(t, 0, e) }, o.isTweening = function(t) { return i.getTweensOf(t, !0).length > 0 };
                var u = function(t, e) { for (var s = [], n = 0, o = t._first; o;) o instanceof i ? s[n++] = o : (e && (s[n++] = o), s = s.concat(u(o, e)), n = s.length), o = o._next; return s },
                ...
                o.killAll = function(t, i, s, n) {
                    ...
                    var o, r, a, l = p(0 != n),
                        h = l.length,
                        c = i && s && n;
                    for (a = 0; h > a; a++) r = l[a], (c || r instanceof e || (o = r.target === r.vars.onComplete) && s || i && !o) && (t ? r.totalTime(r._reversed ? 0 : r.totalDuration()) : r._enabled(!1, !1))
                }, o.killChildTweensOf = function(t, e) {
                    if (null != t) {
                        var n, h, c, u, p, d = r.tweenLookup;
                        if ("string" == typeof t && (t = i.selector(t) || t), a(t) && (t = s(t)), l(t))
                            for (u = t.length; --u > -1;) o.killChildTweensOf(t[u], e);
                        else {
                            n = [];
                            for (c in d)
                                for (h = d[c].target.parentNode; h;) h === t && (n = n.concat(d[c].tweens)), h = h.parentNode;
                            for (p = n.length, u = 0; p > u; u++) e && n[u].totalTime(n[u].totalDuration()), n[u]._enabled(!1, !1)
                        }
                    }
                };
                var d = function(t, i, s, n) { i = !1 !== i, s = !1 !== s; for (var o, r, a = p(n = !1 !== n), l = i && s && n, h = a.length; --h > -1;) r = a[h], (l || r instanceof e || (o = r.target === r.vars.onComplete) && s || i && !o) && r.paused(t) };
                return o.pauseAll = function(t, e, i) { d(!0, t, e, i) }, o.resumeAll = function(t, e, i) { d(!1, t, e, i) }, o.globalTimeScale = function(e) {
                ...
                }, h.progress = function(t) { return arguments.length ? this.totalTime(this.duration() * (this._yoyo && 0 != (1 & this._cycle) ? 1 - t : t) + this._cycle * (this._duration + this._repeatDelay), !1) : this._time / this.duration() }, h.totalProgress = function(t) { return arguments.length ? this.totalTime(this.totalDuration() * t, !1) : this._totalTime / this.totalDuration() }, h.time = function(t, e) { return arguments.length ? (this._dirty && this.totalDuration(), t > this._duration && (t = this._duration), this._yoyo && 0 != (1 & this._cycle) ? t = this._duration - t + this._cycle * (this._duration + this._repeatDelay) : 0 !== this._repeat && (t += this._cycle * (this._duration + this._repeatDelay)), this.totalTime(t, e)) : this._time }, h.duration = function(e) { return arguments.length ? t.prototype.duration.call(this, e) : this._duration }, h.totalDuration = function(t) { return arguments.length ? -1 === this._repeat ? this : this.duration((t - this._repeat * this._repeatDelay) / (this._repeat + 1)) : (this._dirty && (this._totalDuration = -1 === this._repeat ? 999999999999 : this._duration * (this._repeat + 1) + this._repeatDelay * this._repeat, this._dirty = !1), this._totalDuration) }, h.repeat = function(t) { return arguments.length ? (this._repeat = t, this._uncache(!0)) : this._repeat }, h.repeatDelay = function(t) { return arguments.length ? (this._repeatDelay = t, this._uncache(!0)) : this._repeatDelay }, h.yoyo = function(t) { return arguments.length ? (this._yoyo = t, this) : this._yoyo }, o
            }, !0), _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                var s = function(t) {
                        e.call(this, t), this._labels = {}, this.autoRemoveChildren = !0 === this.vars.autoRemoveChildren, this.smoothChildTiming = !0 === this.vars.smoothChildTiming, this._sortChildren = !0, this._onUpdate = this.vars.onUpdate;
                        var i, s, n = this.vars;
                        for (s in n) i = n[s], a(i) && -1 !== i.join("").indexOf("{self}") && (n[s] = this._swapSelfInParams(i));
                    ...
                    m = s.prototype = new e;
                return s.version = "1.18.2", m.constructor = s, m.kill()._gc = m._forcingPlayhead = m._hasPause = !1, m.to = function(t, e, s, n) { var o = s.repeat && c.TweenMax || i; return e ? this.add(new o(t, e, s), n) : this.set(t, s, n) }, m.from = function(t, e, s, n) { return this.add((s.repeat && c.TweenMax || i).from(t, e, s), n) }, m.fromTo = function(t, e, s, n, o) { var r = n.repeat && c.TweenMax || i; return e ? this.add(r.fromTo(t, e, s, n), o) : this.set(t, n, o) }, m.staggerTo = function(t, e, n, o, a, l, h, c) {
                    var d, m, g = new s({ onComplete: l, onCompleteParams: h, callbackScope: c, smoothChildTiming: this.smoothChildTiming }),
                        _ = n.cycle;
                    for ("string" == typeof t && (t = i.selector(t) || t), r(t = t || []) && (t = f(t)), 0 > (o = o || 0) && ((t = f(t)).reverse(), o *= -1), m = 0; m < t.length; m++)(d = u(n)).startAt && (d.startAt = u(d.startAt), d.startAt.cycle && p(d.startAt, t, m)), _ && p(d, t, m), g.to(t[m], e, d, m * o);
                    return this.add(g, a)
                }, m.staggerFrom = function(t, e, i, s, n, o, r, a) { return i.immediateRender = 0 != i.immediateRender, i.runBackwards = !0, this.staggerTo(t, e, i, s, n, o, r, a) }, m.staggerFromTo = function(t, e, i, s, n, o, r, a, l) { return s.startAt = i, s.immediateRender = 0 != s.immediateRender && 0 != i.immediateRender, this.staggerTo(t, e, s, n, o, r, a, l) }, m.call = function(t, e, s, n) { return this.add(i.delayedCall(0, t, e, s), n) }, m.set = function(t, e, s) { return s = this._parseTimeOrLabel(s, 0, !0), null == e.immediateRender && (e.immediateRender = s === this._time && !this._paused), this.add(new i(t, 0, e), s) }, s.exportRoot = function(t, e) {
                    null == (t = t || {}).smoothChildTiming && (t.smoothChildTiming = !0);
                    var n, o, r = new s(t),
                        a = r._timeline;
                    for (null == e && (e = !0), a._remove(r, !0), r._startTime = 0, r._rawPrevTime = r._time = r._totalTime = a._time, n = a._first; n;) o = n._next, e && n instanceof i && n.target === n.vars.onComplete || r.add(n, n._startTime - n._delay), n = o;
                    return a.add(r, 0), r
                }, m.add = function(n, o, r, l) {
                    var h, c, u, p, d, f;
                    if ("number" != typeof o && (o = this._parseTimeOrLabel(o, 0, !0, n)), !(n instanceof t)) {
                        if (n instanceof Array || n && n.push && a(n)) { for (r = r || "normal", l = l || 0, h = o, c = n.length, u = 0; c > u; u++) a(p = n[u]) && (p = new s({ tweens: p })), this.add(p, h), "string" != typeof p && "function" != typeof p && ("sequence" === r ? h = p._startTime + p.totalDuration() / p._timeScale : "start" === r && (p._startTime -= p.delay())), h += l; return this._uncache(!0) }
                    ...
                    var s, n, o, r, a, c, u, p = this._dirty ? this.totalDuration() : this._totalDuration,
                        d = this._time,
                        f = this._startTime,
                        m = this._timeScale,
                        g = this._paused;
                    if (t >= p - 1e-7) this._totalTime = this._time = p, this._reversed || this._hasPausedChild() || (n = !0, r = "onComplete", a = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || this._rawPrevTime < 0 || 1e-10 === this._rawPrevTime) && this._rawPrevTime !== t && this._first && (a = !0, this._rawPrevTime > 1e-10 && (r = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : 1e-10, t = p + 1e-4;
                    else if (1e-7 > t)
                        if (this._totalTime = this._time = 0, (0 !== d || 0 === this._duration && 1e-10 !== this._rawPrevTime && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (r = "onReverseComplete", n = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (a = n = !0, r = "onReverseComplete") : this._rawPrevTime >= 0 && this._first && (a = !0), this._rawPrevTime = t;
                        else {
                    ...
                    if (this._time !== d && this._first || i || a || c) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== d && t > 0 && (this._active = !0), 0 === d && this.vars.onStart && 0 !== this._time && (e || this._callback("onStart")), (u = this._time) >= d)
                            for (s = this._first; s && (o = s._next, u === this._time && (!this._paused || g));)(s._active || s._startTime <= u && !s._paused && !s._gc) && (c === s && this.pause(), s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = o;
                        else
                    ...
                    return !1
                }, m.getChildren = function(t, e, s, n) { n = n || -9999999999; for (var o = [], r = this._first, a = 0; r;) r._startTime < n || (r instanceof i ? !1 !== e && (o[a++] = r) : (!1 !== s && (o[a++] = r), !1 !== t && (o = o.concat(r.getChildren(!0, e, s)), a = o.length))), r = r._next; return o }, m.getTweensOf = function(t, e) {
                    var s, n, o = this._gc,
                        r = [],
                        a = 0;
                    for (o && this._enabled(!0, !0), n = (s = i.getTweensOf(t)).length; --n > -1;)(s[n].timeline === this || e && this._contains(s[n])) && (r[a++] = s[n]);
                    ...
                    i = i || 0;
                    for (var s, n = this._first, o = this._labels; n;) n._startTime >= i && (n._startTime += t), n = n._next;
                    if (e)
                    ...
                    if (!arguments.length) {
                        if (this._dirty) {
                            for (var e, i, s = 0, n = this._last, o = 999999999999; n;) e = n._prev, n._dirty && n.totalDuration(), n._startTime > o && this._sortChildren && !n._paused ? this.add(n, n._startTime - n._delay) : o = n._startTime, n._startTime < 0 && !n._paused && (s -= n._startTime, this._timeline.smoothChildTiming && (this._startTime += n._startTime / this._timeScale), this.shiftChildren(-n._startTime, !1, -9999999999), o = 0), (i = n._startTime + n._totalDuration / n._timeScale) > s && (s = i), n = e;
                ...
                var s = function(e) { t.call(this, e), this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._cycle = 0, this._yoyo = !0 === this.vars.yoyo, this._dirty = !0 },
                    ...
                    l = s.prototype = new t;
                return l.constructor = s, l.kill()._gc = !1, s.version = "1.18.2", l.invalidate = function() { return this._yoyo = !0 === this.vars.yoyo, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._uncache(!0), t.prototype.invalidate.call(this) }, l.addCallback = function(t, i, s, n) { return this.add(e.delayedCall(0, t, s, n), i) }, l.removeCallback = function(t, e) {
                    if (t)
                        if (null == e) this._kill(null, t);
                        else
                            for (var i = this.getTweensOf(t, !1), s = i.length, n = this._parseTimeOrLabel(e); --s > -1;) i[s]._startTime === n && i[s]._enabled(!1, !1);
                    return this
                }, l.removePause = function(e) { return this.removeCallback(t._internals.pauseCallback, e) }, l.tweenTo = function(t, i) { i = i || {}; var s, n, o, r = { ease: a, useFrames: this.usesFrames(), immediateRender: !1 }; for (n in i) r[n] = i[n]; return r.time = this._parseTimeOrLabel(t), s = Math.abs(Number(r.time) - this._time) / this._timeScale || .001, o = new e(this, s, r), r.onStart = function() { o.target.paused(!0), o.vars.time !== o.target.time() && s === o.duration() && o.duration(Math.abs(o.vars.time - o.target.time()) / o.target._timeScale), i.onStart && o._callback("onStart") }, o }, l.tweenFromTo = function(t, e, i) { i = i || {}, t = this._parseTimeOrLabel(t), i.startAt = { onComplete: this.seek, onCompleteParams: [t], callbackScope: this }, i.immediateRender = !1 !== i.immediateRender; var s = this.tweenTo(e, i); return s.duration(Math.abs(s.vars.time - t) / this._timeScale || .001) }, l.render = function(t, e, i) {
                    this._gc && this._enabled(!0, !1);
                    var s, n, a, l, h, c, u, p, d = this._dirty ? this.totalDuration() : this._totalDuration,
                        f = this._duration,
                        m = this._time,
                        g = this._totalTime,
                        _ = this._startTime,
                        ...
                        y = this._paused,
                        w = this._cycle;
                    if (t >= d - 1e-7) this._locked || (this._totalTime = d, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (n = !0, l = "onComplete", h = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || 0 > b || 1e-10 === b) && b !== t && this._first && (h = !0, b > 1e-10 && (l = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : 1e-10, this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : (this._time = f, t = f + 1e-4);
                    else if (1e-7 > t)
                        if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== m || 0 === f && 1e-10 !== b && (b > 0 || 0 > t && b >= 0) && !this._locked) && (l = "onReverseComplete", n = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (h = n = !0, l = "onReverseComplete") : b >= 0 && this._first && (h = !0), this._rawPrevTime = t;
                        else {
                            if (this._rawPrevTime = f || !e || t || this._rawPrevTime === t ? t : 1e-10, 0 === t && n)
                                for (s = this._first; s && 0 === s._startTime;) s._duration || (n = !1), s = s._next;
                    ...
                    if (this._time !== m && this._first || i || h || u) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== g && t > 0 && (this._active = !0), 0 === g && this.vars.onStart && 0 !== this._totalTime && (e || this._callback("onStart")), (p = this._time) >= m)
                            for (s = this._first; s && (a = s._next, p === this._time && (!this._paused || y));)(s._active || s._startTime <= this._time && !s._paused && !s._gc) && (u === s && this.pause(), s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = a;
                        else
                            for (s = this._last; s && (a = s._prev, p === this._time && (!this._paused || y));) {
                    ...
                    var s, n, o = [],
                        ...
                        a = 0,
                        l = r.length;
                    for (s = 0; l > s; s++)(n = r[s]).isActive() && (o[a++] = n);
                    return o
            ...
            function() {
                var t = 180 / Math.PI,
                    ...
                    r = function(t, e, i, s) { this.a = t, this.b = e, this.c = i, this.d = s, this.da = s - t, this.ca = i - t, this.ba = e - t },
                    a = function(t, e, i, s) {
                        var n = { a: t },
                            o = {},
                            r = {},
                    ...
                    c = function(t, o, r, a, c, u) {
                        ...
                        if (t.length > 1) {
                            for (b = t[t.length - 1], v = !0, p = w.length; --p > -1;)
                                if (d = w[p], Math.abs(x[d] - b[d]) > .05) { v = !1; break }
                            v && (t = t.concat(), u && t.unshift(u), t.push(t[1]), u = t[t.length - 3])
                        }
                        for (e.length = i.length = s.length = 0, p = w.length; --p > -1;) d = w[p], n[d] = -1 !== c.indexOf("," + d + ","), y[d] = h(t, d, n[d], u);
                        for (p = e.length; --p > -1;) e[p] = Math.sqrt(e[p]), i[p] = Math.sqrt(i[p]);
                        if (!a) {
                            for (p = w.length; --p > -1;)
                                if (n[d])
                                    for (f = y[w[p]], _ = f.length - 1, m = 0; _ > m; m++) g = f[m + 1].da / i[m] + f[m].da / e[m], s[m] = (s[m] || 0) + g * g;
                            for (p = s.length; --p > -1;) s[p] = Math.sqrt(s[p])
                        }
                        for (p = w.length, m = r ? 4 : 1; --p > -1;) d = w[p], f = y[d], l(f, o, r, a, n[d]), v && (f.splice(0, m), f.splice(f.length - m, m));
                        return y
                    },
                    u = function(t, e, i) {
                        for (var s, n, o, r, a, l, h, c, u, p, d, f = 1 / i, m = t.length; --m > -1;)
                            for (p = t[m], o = p.a, r = p.d - o, a = p.c - o, l = p.b - o, s = n = 0, c = 1; i >= c; c++) h = f * c, u = 1 - h, s = n - (n = (h * h * r + 3 * u * (h * a + u * l)) * h), d = m * i + c - 1, e[d] = (e[d] || 0) + s * s
                    },
                    p = _gsScope._gsDefine.plugin({
                        ...
                        init: function(t, e, i) {
                            ...
                            for (o = this._props.length; --o > -1;) s = this._props[o], this._overwriteProps.push(s), n = this._func[s] = "function" == typeof t[s], p[s] = n ? t[s.indexOf("set") || "function" != typeof t["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : parseFloat(t[s]), l || p[s] !== h[0][s] && (l = p);
                            if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? c(h, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, l) : function(t, e, i) {
                                    ...
                                    for (h = v.length; --h > -1;) {
                                        for (m[p = v[h]] = l = [], d = 0, u = t.length, c = 0; u > c; c++) s = null == i ? t[c][p] : "string" == typeof(f = t[c][p]) && "=" === f.charAt(1) ? i[p] + Number(f.charAt(0) + f.substr(2)) : Number(f), _ && c > 1 && u - 1 > c && (l[d++] = (s + l[d - 2]) / 2), l[d++] = s;
                                        for (u = d - g + 1, d = 0, c = 0; u > c; c += g) s = l[c], n = l[c + 1], o = l[c + 2], a = 2 === g ? 0 : l[c + 3], l[d++] = f = 3 === g ? new r(s, n, o, a) : new r(s, (2 * n + s) / 3, (2 * n + o) / 3, o);
                                        l.length = d
                                    }
                                    return m
                                ...
                                var m = function(t, e) {
                                    ...
                                    for (n = r.length, s = 0; n > s; s++) l += Math.sqrt(r[s]), o = s % e, d[o] = l, o === c && (h += l, o = s / e >> 0, p[o] = d, a[o] = h, l = 0, d = []);
                                    return { length: h, lengths: a, segments: p }
                            ...
                            if (f = this._autoRotate)
                                for (this._initialRotations = [], f[0] instanceof Array || (this._autoRotate = f = [f]), o = f.length; --o > -1;) {
                                    for (a = 0; 3 > a; a++) s = f[o][a], this._func[s] = "function" == typeof t[s] && t[s.indexOf("set") || "function" != typeof t["get" + s.substr(3)] ? s : "get" + s.substr(3)];
                                    s = f[o][2], this._initialRotations[o] = this._func[s] ? this._func[s].call(this._target) : this._target[s]
                                }
                            return this._startRatio = i.vars.runBackwards ? 1 : 0, !0
                        },
                        set: function(e) {
                            var i, s, n, o, r, a, l, h, c, u, p = this._segCount,
                                d = this._func,
                                f = this._target,
                            ...
                            for (s = 1 - a, n = this._props.length; --n > -1;) o = this._props[n], r = this._beziers[o][i], l = (a * a * r.da + 3 * s * (a * r.ca + s * r.ba)) * a + r.a, this._round[o] && (l = Math.round(l)), d[o] ? f[o](l) : f[o] = l;
                            if (this._autoRotate) { var g, _, v, b, y, w, x, T = this._autoRotate; for (n = T.length; --n > -1;) o = T[n][2], w = T[n][3] || 0, x = !0 === T[n][4] ? 1 : t, r = this._beziers[T[n][0]], g = this._beziers[T[n][1]], r && g && (r = r[i], g = g[i], _ = r.a + (r.b - r.a) * a, b = r.b + (r.c - r.b) * a, _ += (b - _) * a, b += (r.c + (r.d - r.c) * a - b) * a, v = g.a + (g.b - g.a) * a, y = g.b + (g.c - g.b) * a, v += (y - v) * a, y += (g.c + (g.d - g.c) * a - y) * a, l = m ? Math.atan2(y - v, b - _) * x + w : this._initialRotations[n], d[o] ? f[o](l) : f[o] = l) }
                        }
                    }),
                    d = p.prototype;
                p.bezierThrough = c, p.cubicToQuadratic = a, p._autoCSS = !0, p.quadraticToCubic = function(t, e, i) { return new r(t, (2 * e + t) / 3, (2 * e + i) / 3, i) }, p._cssRegister = function() {
                    var t = o.CSSPlugin;
                    if (t) {
                        var e = t._internals,
                            i = e._parseToProxy,
                        ...
                        e._registerComplexSpecialProp("bezier", {
                            parser: function(t, e, o, r, a, l) {
                                ...
                                for (c in e) g[c] = e[c];
                                return g.values = m, a = new n(t, "bezier", 0, 0, u.pt, 2), a.data = u, a.plugin = l, a.setRatio = s, 0 === g.autoRotate && (g.autoRotate = !0), !g.autoRotate || g.autoRotate instanceof Array || (h = !0 === g.autoRotate ? 0 : Number(g.autoRotate), g.autoRotate = null != u.end.left ? [
                ...
                var i, s, n, o, r = function() { t.call(this, "css"), this._overwriteProps.length = 0, this.setRatio = r.prototype.setRatio },
                    a = _gsScope._gsDefine.globals,
                    l = {},
                    h = r.prototype = new t("css");
                h.constructor = r, r.version = "1.18.2", r.API = 2, r.defaultTransformPerspective = 0, r.defaultSkewType = "compensated", r.defaultSmoothOrigin = !0, h = "px", r.suffixMap = { top: h, right: h, bottom: h, left: h, width: h, height: h, fontSize: h, padding: h, margin: h, perspective: h, lineHeight: "" };
                var c, u, p, d, f, m, g = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    _ = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
                    ...
                    I = {},
                    L = document,
                    N = function(t) { return L.createElementNS ? L.createElementNS("http://www.w3.org/1999/xhtml", t) : L.createElement(t) },
                    z = N("div"),
                    j = N("img"),
                    ...
                    W = function(t) { return w.test("string" == typeof t ? t : (t.currentStyle ? t.currentStyle.filter : t.style.filter) || "") ? parseFloat(RegExp.$1) / 100 : 1 },
                    Y = function(t) { window.console && console.log(t) },
                    B = "",
                    q = "",
                    V = function(t, e) { var i, s, n = (e = e || z).style; if (void 0 !== n[t]) return t; for (t = t.charAt(0).toUpperCase() + t.substr(1), i = ["O", "Moz", "ms", "Ms", "Webkit"], s = 5; --s > -1 && void 0 === n[i[s] + t];); return s >= 0 ? (q = 3 === s ? "ms" : i[s], B = "-" + q.toLowerCase() + "-", q + t) : null },
                    U = L.defaultView ? L.defaultView.getComputedStyle : function() {},
                    Q = r.getStyle = function(t, e, i, s, n) { var o; return X || "opacity" !== e ? (!s && t.style[e] ? o = t.style[e] : (i = i || U(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(C, "-$1").toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == n || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : n) : W(t) },
                    G = F.convertToPixels = function(t, i, s, n, o) {
                        ...
                        var a, l, h, c = A.test(i),
                            ...
                            p = z.style,
                            d = 0 > s;
                        if (d && (s = -s), "%" === n && -1 !== i.indexOf("border")) a = s / 100 * (c ? t.clientWidth : t.clientHeight);
                        else {
                            if (p.cssText = "border:0 solid red;position:" + Q(t, "position") + ";line-height:0;", "%" !== n && u.appendChild && "v" !== n.charAt(0) && "rem" !== n) p[c ? "borderLeftWidth" : "borderTopWidth"] = s + n;
                            else {
                    ...
                    K = function(t, e) {
                        ...
                        if (e = e || U(t, null))
                            if (i = e.length)
                                for (; --i > -1;)(-1 === (n = e[i]).indexOf("-transform") || Ct === n) && (o[n.replace(S, E)] = e.getPropertyValue(n));
                            else
                                for (i in e)(-1 === i.indexOf("Transform") || kt === i) && (o[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e) "string" == typeof i && void 0 === o[i] && (o[i.replace(S, E)] = e[i]);
                    ...
                    J = function(t, e, i, s, n) {
                        var o, r, a, l = {},
                            h = t.style;
                        for (r in i) "cssText" !== r && "length" !== r && isNaN(r) && (e[r] !== (o = i[r]) || n && n[r]) && -1 === r.indexOf("Origin") && ("number" == typeof o || "string" == typeof o) && (l[r] = "auto" !== o || "left" !== r && "top" !== r ? "" !== o && "auto" !== o && "none" !== o || "string" != typeof e[r] || "" === e[r].replace(b, "") ? o : 0 : Z(t, r), void 0 !== h[r] && (a = new ft(h, r, h[r], a)));
                        if (s)
                    ...
                    it = function(t, e, i) {
                        var s = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
                            n = tt[e],
                            o = n.length;
                        for (i = i || U(t, null); --o > -1;) s -= parseFloat(Q(t, "padding" + n[o], i, !0)) || 0, s -= parseFloat(Q(t, "border" + n[o] + "Width", i, !0)) || 0;
                        return s
                    },
                    st = function(t, e) {
                    ...
                    ot = function(t, e) { return null == t ? e : "string" == typeof t && "=" === t.charAt(1) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(t.substr(2)) + e : parseFloat(t) },
                    rt = function(t, e, i, s) { var n, o, r, a, l; return null == t ? a = e : "number" == typeof t ? a = t : (n = 360, o = t.split("_"), l = "=" === t.charAt(1), r = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(o[0].substr(2)) : parseFloat(o[0])) * (-1 === t.indexOf("rad") ? 1 : M) - (l ? 0 : e), o.length && (s && (s[i] = e + r), -1 !== t.indexOf("short") && (r %= n) != r % (n / 2) && (r = 0 > r ? r + n : r - n), -1 !== t.indexOf("_cw") && 0 > r ? r = (r + 9999999999 * n) % n - (r / n | 0) * n : -1 !== t.indexOf("ccw") && r > 0 && (r = (r - 9999999999 * n) % n - (r / n | 0) * n)), a = e + r), 1e-6 > a && a > -1e-6 && (a = 0), a },
                    ...
                    lt = function(t, e, i) { return 255 * (1 > 6 * (t = 0 > t ? t + 1 : t > 1 ? t - 1 : t) ? e + (i - e) * t * 6 : .5 > t ? i : 2 > 3 * t ? e + (i - e) * (2 / 3 - t) * 6 : e) + .5 | 0 },
                    ht = r.parseColor = function(t, e) {
                        ...
                        if (t)
                            if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                                ...
                                else if ("#" === t.charAt(0)) 4 === t.length && (s = t.charAt(1), n = t.charAt(2), o = t.charAt(3), t = "#" + s + s + n + n + o + o), t = parseInt(t.substr(1), 16), i = [t >> 16, t >> 8 & 255, 255 & t];
                                else if ("hsl" === t.substr(0, 3))
                                    if (i = p = t.match(g), e) { if (-1 !== t.indexOf("=")) return t.match(_) } else r = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, l = Number(i[2]) / 100, n = .5 >= l ? l * (a + 1) : l + a - l * a, s = 2 * l - n, i.length > 3 && (i[3] = Number(t[3])), i[0] = lt(r + 1 / 3, s, n), i[1] = lt(r, s, n), i[2] = lt(r - 1 / 3, s, n);
                    ...
                    ct = function(t, e) {
                        var i, s, n, o = t.match(ut) || [],
                            r = 0,
                            a = o.length ? "" : t;
                        for (i = 0; i < o.length; i++) s = o[i], n = t.substr(r, t.indexOf(s, r) - r), r += n.length + s.length, 3 === (s = ht(s, e)).length && s.push(1), a += n + (e ? "hsla(" + s[0] + "," + s[1] + "%," + s[2] + "%," + s[3] : "rgba(" + s.join(",")) + ")";
                        return a
                    },
                ...
                var pt = function(t, e, i, s) {
                        ...
                        return c ? n = e ? function(t) {
                            ...
                            else if (s && R.test(t)) { for (f = t.replace(R, "|").split("|"), d = 0; d < f.length; d++) f[d] = n(f[d]); return f.join(",") }
                            if (e = (t.match(ut) || [o])[0], p = t.split(e).join("").match(v) || [], d = p.length, c > d--)
                                for (; ++d < c;) p[d] = i ? p[(d - 1) / 2 | 0] : r[d];
                            return a + p.join(h) + h + e + l + (-1 !== t.indexOf("inset") ? " inset" : "")
                        } : function(t) {
                            var e, o, p;
                            if ("number" == typeof t) t += u;
                            else if (s && R.test(t)) { for (o = t.replace(R, "|").split("|"), p = 0; p < o.length; p++) o[p] = n(o[p]); return o.join(",") }
                            if (e = t.match(v) || [], p = e.length, c > p--)
                                for (; ++p < c;) e[p] = i ? e[(p - 1) / 2 | 0] : r[p];
                            return a + e.join(h) + l
                        } : function(t) { return t }
                    },
                    dt = function(t) {
                        return t = t.split(","),
                            function(e, i, s, n, o, r, a) { var l, h = (i + "").split(" "); for (a = {}, l = 0; 4 > l; l++) a[t[l]] = h[l] = h[l] || h[(l - 1) / 2 >> 0]; return n.parse(e, a, o, r) }
                    },
                    ft = (F._setPluginRatio = function(t) {
                        this.plugin.setRatio(t);
                        for (var e, i, s, n, o, r = this.data, a = r.proxy, l = r.firstMPT; l;) e = a[l.v], l.r ? e = Math.round(e) : 1e-6 > e && e > -1e-6 && (e = 0), l.t[l.p] = e, l = l._next;
                    ...
                    mt = (F._parseToProxy = function(t, e, i, s, n, o) {
                        ...
                        for (i._transform = null, I = e, s = c = i.parse(t, e, s, n), I = m, o && (i._transform = f, u && (u._prev = null, u._prev && (u._prev._next = null))); s && s !== u;) {
                            if (s.type <= 1 && (a = s.p, d[a] = s.s + s.c, p[a] = s.s, o || (h = new ft(s, "s", a, h, s.r), s.c = 0), 1 === s.type))
                                for (r = s.l; --r > 0;) l = "xn" + r, a = s.p + "_" + l, d[a] = s.data[l], p[a] = s[l], o || (h = new ft(s, l, a, h, s.rxp[l]));
                            s = s._next
                        }
                        return { proxy: p, end: d, firstMPT: h, pt: c }
                    }, F.CSSPropTween = function(t, e, s, n, r, a, l, h, c, u, p) { this.t = t, this.p = e, this.s = s, this.c = n, this.n = l || e, t instanceof mt || o.push(this.n), this.r = h, this.type = a || 0, c && (this.pr = c, i = !0), this.b = void 0 === u ? s : u, this.e = void 0 === p ? s + n : p, r && (this._next = r, r._prev = this) }),
                    gt = function(t, e, i, s, n, o) { var r = new mt(t, e, i, s - i, n, -1, o); return r.b = i, r.e = r.xs0 = s, r },
                    _t = r.parseComplex = function(t, e, i, s, n, o, r, a, l, h) {
                        i = i || o || "", r = new mt(t, e, 0, 0, r, h ? 2 : 1, null, !1, a, i, s), s += "";
                        var u, p, d, f, m, v, b, y, w, x, T, k, C, S = i.split(", ").join(",").split(" "),
                        ...
                        for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (S = S.join(" ").replace(R, ", ").split(" "), P = P.join(" ").replace(R, ", ").split(" "), E = S.length), E !== P.length && (S = (o || "").split(" "), E = S.length), r.plugin = l, r.setRatio = h, ut.lastIndex = 0, u = 0; E > u; u++)
                            if (f = S[u], m = P[u], (y = parseFloat(f)) || 0 === y) r.appendXtra("", y, nt(m, y), m.replace(_, ""), A && -1 !== m.indexOf("px"), !0);
                            else if (n && ut.test(f)) k = "," === m.charAt(m.length - 1) ? ")," : ")", C = -1 !== m.indexOf("hsl") && X, f = ht(f, C), m = ht(m, C), (w = f.length + m.length > 6) && !X && 0 === m[3] ? (r["xs" + r.l] += r.l ? " transparent" : "transparent", r.e = r.e.split(P[u]).join("transparent")) : (X || (w = !1), C ? r.appendXtra(w ? "hsla(" : "hsl(", f[0], nt(m[0], f[0]), ",", !1, !0).appendXtra("", f[1], nt(m[1], f[1]), "%,", !1).appendXtra("", f[2], nt(m[2], f[2]), w ? "%," : "%" + k, !1) : r.appendXtra(w ? "rgba(" : "rgb(", f[0], m[0] - f[0], ",", !0, !0).appendXtra("", f[1], m[1] - f[1], ",", !0).appendXtra("", f[2], m[2] - f[2], w ? "," : k, !0), w && (f = f.length < 4 ? 1 : f[3], r.appendXtra("", f, (m.length < 4 ? 1 : m[3]) - f, k, !1))), ut.lastIndex = 0;
                        else if (v = f.match(g)) {
                            if (!(b = m.match(_)) || b.length !== v.length) return r;
                            for (d = 0, p = 0; p < v.length; p++) T = v[p], x = f.indexOf(T, d), r.appendXtra(f.substr(d, x - d), Number(T), nt(b[p], T), "", A && "px" === f.substr(x + T.length, 2), 0 === p), d = x + T.length;
                            r["xs" + r.l] += f.substr(d)
                        } else r["xs" + r.l] += r.l ? " " + m : m;
                        if (-1 !== s.indexOf("=") && r.data) {
                            for (k = r.xs0 + r.data.s, u = 1; u < r.l; u++) k += r["xs" + u] + r.data["xn" + u];
                            r.e = k + r["xs" + u]
                        }
                        return r.l || (r.type = -1, r.xs0 = r.e), r.xfirst || r
                    },
                    vt = 9;
                for ((h = mt.prototype).l = h.pr = 0; --vt > 0;) h["xn" + vt] = 0, h["xs" + vt] = "";
                h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function(t, e, i, s, n, o) { var r = this.l; return this["xs" + r] += o && r ? " " + t : t || "", i || 0 === r || this.plugin ? (this.l++, this.type = this.setRatio ? 2 : 1, this["xs" + this.l] = s || "", r > 0 ? (this.data["xn" + r] = e + i, this.rxp["xn" + r] = n, this["xn" + r] = e, this.plugin || (this.xfirst = new mt(this, "xn" + r, e, i, this.xfirst || this, 0, this.n, n, this.pr), this.xfirst.xs0 = 0), this) : (this.data = { s: e + i }, this.rxp = {}, this.s = e, this.c = i, this.r = n, this)) : (this["xs" + r] += e + (s || ""), this) };
                var bt = function(t, e) { e = e || {}, this.p = e.prefix ? V(t) || t : t, l[t] = l[this.p] = this, this.format = e.formatter || pt(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0 },
                    yt = F._registerComplexSpecialProp = function(t, e, i) {
                        "object" != typeof e && (e = { parser: i });
                        var s, n = t.split(","),
                            o = e.defaultValue;
                        for (i = i || [o], s = 0; s < n.length; s++) e.prefix = 0 === s && e.prefix, e.defaultValue = i[s] || o, new bt(n[s], e)
                    },
                    wt = function(t) {
                        if (!l[t]) {
                            var e = t.charAt(0).toUpperCase() + t.substr(1) + "Plugin";
                            yt(t, { parser: function(t, i, s, n, o, r, h) { var c = a.com.greensock.plugins[e]; return c ? (c._cssRegister(), l[s].parse(t, i, s, n, o, r, h)) : (Y("Error: " + e + " js file not loaded."), o) } })
                        }
                    };
                (h = bt.prototype).parseComplex = function(t, e, i, s, n, o) {
                    ...
                    if (this.multi && (R.test(i) || R.test(e) ? (a = e.replace(R, "|").split("|"), l = i.replace(R, "|").split("|")) : p && (a = [e], l = [i])), l) {
                        for (h = l.length > a.length ? l.length : a.length, r = 0; h > r; r++) e = a[r] = a[r] || this.dflt, i = l[r] = l[r] || this.dflt, p && (c = e.indexOf(p), u = i.indexOf(p), c !== u && (-1 === u ? a[r] = a[r].split(p).join("") : -1 === c && (a[r] += " " + p)));
                        e = a.join(", "), i = l.join(", ")
                    }
                    return _t(t, this.p, e, i, this.clrs, this.dflt, s, this.pr, n, o)
                }, h.parse = function(t, e, i, s, o, r, a) { return this.parseComplex(t.style, this.format(Q(t, this.p, n, !1, this.dflt)), this.format(e), o, r) }, r.registerSpecialProp = function(t, e, i) { yt(t, { parser: function(t, s, n, o, r, a, l) { var h = new mt(t, n, 0, 0, r, 2, n, !1, i); return h.plugin = a, h.setRatio = e(t, s, o._tween, n), h }, priority: i }) }, r.useSVGTransformAttr = p || d;
                var xt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Et = F.Transform = function() { this.perspective = parseFloat(r.defaultTransformPerspective) || 0, this.force3D = !(!1 === r.defaultForce3D || !Pt) && (r.defaultForce3D || "auto") },
                    At = window.SVGElement,
                    Dt = function(t, e, i) {
                        var s, n = L.createElementNS("http://www.w3.org/2000/svg", t),
                            o = /([a-z])([A-Z])/g;
                        for (s in i) n.setAttributeNS(null, s.replace(o, "$1-$2").toLowerCase(), i[s]);
                        return e.appendChild(n), n
                    },
                    Ot = L.documentElement,
                    Rt = function() { var t, e, i, s = m || /Android/i.test(H) && !window.chrome; return L.createElementNS && !s && (t = Dt("svg", Ot), e = Dt("rect", t, { width: 100, height: 50, x: 100 }), i = e.getBoundingClientRect().width, e.style[St] = "50% 50%", e.style[kt] = "scaleX(0.5)", s = i === e.getBoundingClientRect().width && !(d && Pt), Ot.removeChild(t)), s }(),
                    $t = function(t, e, i, s, n) {
                        var o, a, l, h, c, u, p, d, f, m, g, _, v, b, y = t._gsTransform,
                            w = Lt(t, !0);
                    ...
                    Mt = function(t) { return !!(At && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)) },
                    It = [1, 0, 0, 1, 0, 0],
                    Lt = function(t, e) { var i, s, n, o, r, a = t._gsTransform || new Et; if (kt ? s = Q(t, Ct, null, !0) : t.currentStyle && (s = t.currentStyle.filter.match(D), s = s && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), a.x || 0, a.y || 0].join(",") : ""), i = !s || "none" === s || "matrix(1, 0, 0, 1, 0, 0)" === s, (a.svg || t.getBBox && Mt(t)) && (i && -1 !== (t.style[kt] + "").indexOf("matrix") && (s = t.style[kt], i = 0), n = t.getAttribute("transform"), i && n && (-1 !== n.indexOf("matrix") ? (s = n, i = 0) : -1 !== n.indexOf("translate") && (s = "matrix(1,0,0,1," + n.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return It; for (n = (s || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], vt = n.length; --vt > -1;) o = Number(n[vt]), n[vt] = (r = o - (o |= 0)) ? (1e5 * r + (0 > r ? -.5 : .5) | 0) / 1e5 + o : o; return e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n },
                    Nt = F.getTransform = function(t, i, s, o) {
                        if (t._gsTransform && s && !o) return t._gsTransform;
                        var a, l, h, c, u, p, d = s ? t._gsTransform || new Et : new Et,
                            f = d.scaleX < 0,
                        ...
                        return s && (t._gsTransform = d, d.svg && (xt && t.style[kt] ? e.delayedCall(.001, function() { Ft(t.style, kt) }) : !xt && t.getAttribute("transform") && e.delayedCall(.001, function() { t.removeAttribute("transform") }))), d
                    },
                    zt = F.set3DTransformRatio = F.setTransformRatio = function(t) {
                        var e, i, s, n, o, r, a, l, h, c, u, p, f, m, g, _, v, b, y, w, x, T = this.data,
                            k = this.t.style,
                            C = T.rotation,
                            S = T.rotationX,
                            P = T.rotationY,
                            ...
                            L = T.perspective,
                            N = T.force3D;
                        if (!((1 !== t && 0 !== t || "auto" !== N || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && N || M || L || P || S || 1 !== D) || xt && I || !Pt) C || T.skewX || I ? (C *= $, w = T.skewX * $, x = 1e5, e = Math.cos(C) * E, n = Math.sin(C) * E, i = Math.sin(C - w) * -A, o = Math.cos(C - w) * A, w && "simple" === T.skewType && (v = Math.tan(w), v = Math.sqrt(1 + v * v), i *= v, o *= v, T.skewY && (e *= v, n *= v)), I && (O += T.xOrigin - (T.xOrigin * e + T.yOrigin * i) + T.xOffset, R += T.yOrigin - (T.xOrigin * n + T.yOrigin * o) + T.yOffset, xt && (T.xPercent || T.yPercent) && (m = this.t.getBBox(), O += .01 * T.xPercent * m.width, R += .01 * T.yPercent * m.height), (m = 1e-6) > O && O > -m && (O = 0), m > R && R > -m && (R = 0)), y = (e * x | 0) / x + "," + (n * x | 0) / x + "," + (i * x | 0) / x + "," + (o * x | 0) / x + "," + O + "," + R + ")", I && xt ? this.t.setAttribute("transform", "matrix(" + y) : k[kt] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + y) : k[kt] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + E + ",0,0," + A + "," + O + "," + R + ")";
                        else {
                            if (d && ((m = 1e-4) > E && E > -m && (E = D = 2e-5), m > A && A > -m && (A = D = 2e-5), !L || T.z || T.rotationX || T.rotationY || (L = 0)), C || T.skewX) C *= $, g = e = Math.cos(C), _ = n = Math.sin(C), T.skewX && (C -= T.skewX * $, g = Math.cos(C), _ = Math.sin(C), "simple" === T.skewType && (v = Math.tan(T.skewX * $), v = Math.sqrt(1 + v * v), g *= v, _ *= v, T.skewY && (e *= v, n *= v))), i = -_, o = g;
                            else {
                ...
                (h = Et.prototype).x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, yt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    parser: function(t, e, i, s, o, a, l) {
                        ...
                        var h, c, u, p, d, f, m, g, _, v, b = t._gsTransform,
                            y = t.style,
                            w = Tt.length,
                            x = l,
                            T = {},
                            k = "transformOrigin";
                        if (l.display ? (p = Q(t, "display"), y.display = "block", h = Nt(t, n, !0, l.parseTransform), y.display = p) : h = Nt(t, n, !0, l.parseTransform), s._transform = h, "string" == typeof x.transform && kt) p = z.style, p[kt] = x.transform, p.display = "block", p.position = "absolute", L.body.appendChild(z), c = Nt(z, null, !1), L.body.removeChild(z), c.perspective || (c.perspective = h.perspective), null != x.xPercent && (c.xPercent = ot(x.xPercent, h.xPercent)), null != x.yPercent && (c.yPercent = ot(x.yPercent, h.yPercent));
                        else if ("object" == typeof x) {
                            if (c = { scaleX: ot(null != x.scaleX ? x.scaleX : x.scale, h.scaleX), scaleY: ot(null != x.scaleY ? x.scaleY : x.scale, h.scaleY), scaleZ: ot(x.scaleZ, h.scaleZ), x: ot(x.x, h.x), y: ot(x.y, h.y), z: ot(x.z, h.z), xPercent: ot(x.xPercent, h.xPercent), yPercent: ot(x.yPercent, h.yPercent), perspective: ot(x.transformPerspective, h.perspective) }, null != (g = x.directionalRotation))
                                if ("object" == typeof g)
                                    for (p in g) x[p] = g[p];
                                else x.rotation = g;
                        ...
                        for (Pt && null != x.force3D && (h.force3D = x.force3D, m = !0), h.skewType = x.skewType || h.skewType || r.defaultSkewType, (f = h.force3D || h.z || h.rotationX || h.rotationY || c.z || c.rotationX || c.rotationY || c.perspective) || null == x.scale || (c.scaleZ = 1); --w > -1;) i = Tt[w], ((d = c[i] - h[i]) > 1e-6 || -1e-6 > d || null != x[i] || null != I[i]) && (m = !0, o = new mt(h, i, h[i], d, o), i in T && (o.e = T[i]), o.xs0 = 0, o.plugin = a, s._overwriteProps.push(o.n));
                    ...
                    prefix: !0
                }), yt("boxShadow", { defaultValue: "0px 0px 0px 0px #999", prefix: !0, color: !0, multi: !0, keyword: "inset" }), yt("borderRadius", {
                    defaultValue: "0px",
                    parser: function(t, e, i, o, r, a) {
                        e = this.format(e);
                        var l, h, c, u, p, d, f, m, g, _, v, b, y, w, x, T, k = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                            C = t.style;
                    ...
                    parser: function(t, e, i, s, o, r) {
                        ...
                        if (-1 !== g.indexOf("%") != (-1 !== _.indexOf("%")) && (p = Q(t, "backgroundImage").replace(P, "")) && "none" !== p) {
                            for (a = g.split(" "), l = _.split(" "), j.setAttribute("src", p), h = 2; --h > -1;) g = a[h], (c = -1 !== g.indexOf("%")) !== (-1 !== l[h].indexOf("%")) && (u = 0 === h ? t.offsetWidth - j.width : t.offsetHeight - j.height, a[h] = c ? parseFloat(g) / 100 * u + "px" : parseFloat(g) / u * 100 + "%");
                            g = a.join(" ")
                        }
                        return this.parseComplex(t.style, g, _, o, r)
                    },
                    formatter: st
                }), yt("backgroundSize", { defaultValue: "0 0", formatter: st }), yt("perspective", { defaultValue: "0px", prefix: !0 }), yt("perspectiveOrigin", { defaultValue: "50% 50%", prefix: !0 }), yt("transformStyle", { prefix: !0 }), yt("backfaceVisibility", { prefix: !0 }), yt("userSelect", { prefix: !0 }), yt("margin", { parser: dt("marginTop,marginRight,marginBottom,marginLeft") }), yt("padding", { parser: dt("paddingTop,paddingRight,paddingBottom,paddingLeft") }), yt("clip", { defaultValue: "rect(0px,0px,0px,0px)", parser: function(t, e, i, s, o, r) { var a, l, h; return 9 > m ? (l = t.currentStyle, h = 8 > m ? " " : ",", a = "rect(" + l.clipTop + h + l.clipRight + h + l.clipBottom + h + l.clipLeft + ")", e = this.format(e).split(",").join(h)) : (a = this.format(Q(t, this.p, n, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, a, e, o, r) } }), yt("textShadow", { defaultValue: "0px 0px 0px #999", color: !0, multi: !0 }), yt("autoRound,strictUnits", { parser: function(t, e, i, s, n) { return n } }), yt("border", { defaultValue: "0px solid #000", parser: function(t, e, i, s, o, r) { return this.parseComplex(t.style, this.format(Q(t, "borderTopWidth", n, !1, "0px") + " " + Q(t, "borderTopStyle", n, !1, "solid") + " " + Q(t, "borderTopColor", n, !1, "#000")), this.format(e), o, r) }, color: !0, formatter: function(t) { var e = t.split(" "); return e[0] + " " + (e[1] || "solid") + " " + (t.match(ut) || ["#000"])[0] } }), yt("borderWidth", { parser: dt("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }), yt("float,cssFloat,styleFloat", {
                ...
                var Ft = function(t, e) { e && (t.removeProperty ? (("ms" === e.substr(0, 2) || "webkit" === e.substr(0, 6)) && (e = "-" + e), t.removeProperty(e.replace(C, "-$1").toLowerCase())) : t.removeAttribute(e)) },
                    Ht = function(t) {
                ...
                var Xt = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        var e, i, s, n, o, r = this.t.style,
                            a = l.transform.parse;
                        if ("all" === this.e) r.cssText = "", n = !0;
                        else
                            for (e = this.e.split(" ").join("").split(","), s = e.length; --s > -1;) i = e[s], l[i] && (l[i].parse === a ? n = !0 : i = "transformOrigin" === i ? St : l[i].p), Ft(r, i);
                ...
                for (yt("clearProps", { parser: function(t, e, s, n, o) { return o = new mt(t, s, 0, 0, o, 2), o.setRatio = Xt, o.e = e, o.pr = -10, o.data = n._tween, i = !0, o } }), h = "bezier,throwProps,physicsProps,physics2D".split(","), vt = h.length; vt--;) wt(h[vt]);
                (h = r.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a) {
                    ...
                    var h, d, g, _, v, b, T, k, C, S = t.style;
                    if (u && "" === S.zIndex && ("auto" === (h = Q(t, "zIndex", n)) || "" === h) && this._addLazySet(S, "zIndex", 0), "string" == typeof e && (_ = S.cssText, h = K(t, n), S.cssText = _ + ";" + e, h = J(t, h, K(t)).difs, !X && x.test(e) && (h.opacity = parseFloat(RegExp.$1)), e = h, S.cssText = _), e.className ? this._firstPT = d = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = d = this.parse(t, e, null), this._transformType) {
                        for (C = 3 === this._transformType, kt ? p && (u = !0, "" === S.zIndex && ("auto" === (T = Q(t, "zIndex", n)) || "" === T) && this._addLazySet(S, "zIndex", 0), f && this._addLazySet(S, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (C ? "visible" : "hidden"))) : S.zoom = 1, g = d; g && g._next;) g = g._next;
                ...
                }, h._enableTransforms = function(t) { this._transform = this._transform || Nt(this._target, n, !0), this._transformType = this._transform.svg && xt || !t && 3 !== this._transformType ? 2 : 3 };
                ...
                var Yt = function(t, e, i) {
                    var s, n, o, r;
                    if (t.slice)
                        for (n = t.length; --n > -1;) Yt(t[n], e, i);
                    else
                        for (s = t.childNodes, n = s.length; --n > -1;) o = s[n], r = o.type, o.style && (e.push(K(o)), i && i.push(o)), 1 !== r && 9 !== r && 11 !== r || !o.childNodes.length || Yt(o, e, i)
                };
                return r.cascadeTo = function(t, i, s) {
                    var n, o, r, a, l = e.to(t, i, s),
                        h = [l],
                        c = [],
                        u = [],
                        p = [],
                    ...
                    for (t = l._targets || l.target, Yt(t, c, p), l.render(i, !0, !0), Yt(t, u), l.render(0, !0, !0), l._enabled(!0), n = p.length; --n > -1;)
                        if ((o = J(p[n], c[n], u[n])).firstMPT) {
                            o = o.difs;
                            for (r in s) d[r] && (o[r] = s[r]);
                            a = {};
                            for (r in o) a[r] = c[n][r];
            ...
            function() {
                ...
                e._onInitAllProps = function() {
                    for (var e, i, s, n = this._tween, o = n.vars.roundProps.join ? n.vars.roundProps : n.vars.roundProps.split(","), r = o.length, a = {}, l = n._propLookup.roundProps; --r > -1;) a[o[r]] = 1;
                    for (r = o.length; --r > -1;)
                        for (e = o[r], i = n._firstPT; i;) s = i._next, i.pg ? i.t._roundProps(a, !0) : i.n === e && (2 === i.f && i.t ? t(i.t._firstPT) : (this._add(i.t, e, i.s, i.c), s && (s._prev = i._prev), i._prev ? i._prev._next = s : n._firstPT === i && (n._firstPT = s), i._next = i._prev = null, n._propLookup[e] = l)), i = s;
                    return !1
                }, e._add = function(t, e, i, s) { this._addTween(t, e, i, i + s, e, !0), this._overwriteProps.push(e) }
            }(), _gsScope._gsDefine.plugin({ propName: "attr", API: 2, version: "0.5.0", init: function(t, e, i) { var s; if ("function" != typeof t.setAttribute) return !1; for (s in e) this._addTween(t, "setAttribute", t.getAttribute(s) + "", e[s] + "", s, !1, s), this._overwriteProps.push(s); return !0 } }), _gsScope._gsDefine.plugin({
                propName: "directionalRotation",
                version: "0.2.1",
                API: 2,
                init: function(t, e, i) { "object" != typeof e && (e = { rotation: e }), this.finals = {}; var s, n, o, r, a, l, h = !0 === e.useRadians ? 2 * Math.PI : 360; for (s in e) "useRadians" !== s && (l = (e[s] + "").split("_"), n = l[0], o = parseFloat("function" != typeof t[s] ? t[s] : t[s.indexOf("set") || "function" != typeof t["get" + s.substr(3)] ? s : "get" + s.substr(3)]()), r = this.finals[s] = "string" == typeof n && "=" === n.charAt(1) ? o + parseInt(n.charAt(0) + "1", 10) * Number(n.substr(2)) : Number(n) || 0, a = r - o, l.length && (-1 !== (n = l.join("_")).indexOf("short") && (a %= h) != a % (h / 2) && (a = 0 > a ? a + h : a - h), -1 !== n.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * h) % h - (a / h | 0) * h : -1 !== n.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * h) % h - (a / h | 0) * h)), (a > 1e-6 || -1e-6 > a) && (this._addTween(t, s, o, o + a, s), this._overwriteProps.push(s))); return !0 },
                set: function(t) {
                    var e;
                ...
                var e, i, s, n = _gsScope.GreenSockGlobals || _gsScope,
                    ...
                    u = function(t, e, i, s, n) { var o = l("easing." + t, { easeOut: new e, easeIn: new i, easeInOut: new s }, !0); return c(o, t), o },
                    ...
                    g = m.prototype = new t;
                return g.constructor = m, g.getRatio = function(t) { var e = t + (.5 - t) * this._p; return t < this._p1 ? this._calcEnd ? 1 - (t = 1 - t / this._p1) * t : e - (t = 1 - t / this._p1) * t * t * t * e : t > this._p3 ? this._calcEnd ? 1 - (t = (t - this._p3) / this._p1) * t : e + (t - e) * (t = (t - this._p3) / this._p1) * t * t * t : this._calcEnd ? 1 : e }, m.ease = new m(.7, .7), g.config = m.config = function(t, e, i) { return new m(t, e, i) }, e = l("easing.SteppedEase", function(t) { t = t || 1, this._p1 = 1 / t, this._p2 = t + 1 }, !0), g = e.prototype = new t, g.constructor = e, g.getRatio = function(t) { return 0 > t ? t = 0 : t >= 1 && (t = .999999999), (this._p2 * t >> 0) * this._p1 }, g.config = e.config = function(t) { return new e(t) }, i = l("easing.RoughEase", function(e) {
                    for (var i, s, n, o, r, a, l = (e = e || {}).taper || "none", h = [], c = 0, u = 0 | (e.points || 20), d = u, f = !1 !== e.randomize, m = !0 === e.clamp, g = e.template instanceof t ? e.template : null, _ = "number" == typeof e.strength ? .4 * e.strength : .4; --d > -1;) i = f ? Math.random() : 1 / u * d, s = g ? g.getRatio(i) : i, "none" === l ? n = _ : "out" === l ? (o = 1 - i, n = o * o * _) : "in" === l ? n = i * i * _ : .5 > i ? (o = 2 * i, n = o * o * .5 * _) : (o = 2 * (1 - i), n = o * o * .5 * _), f ? s += Math.random() * n - .5 * n : d % 2 ? s += .5 * n : s -= .5 * n, m && (s > 1 ? s = 1 : 0 > s && (s = 0)), h[c++] = { x: i, y: s };
                ...
                }, g.config = function(t) { return new i(t) }, i.ease = new i, u("Bounce", h("BounceOut", function(t) { return 1 / 2.75 > t ? 7.5625 * t * t : 2 / 2.75 > t ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375 }), h("BounceIn", function(t) { return (t = 1 - t) < 1 / 2.75 ? 1 - 7.5625 * t * t : 2 / 2.75 > t ? 1 - (7.5625 * (t -= 1.5 / 2.75) * t + .75) : 2.5 / 2.75 > t ? 1 - (7.5625 * (t -= 2.25 / 2.75) * t + .9375) : 1 - (7.5625 * (t -= 2.625 / 2.75) * t + .984375) }), h("BounceInOut", function(t) { var e = .5 > t; return t = e ? 1 - 2 * t : 2 * t - 1, t = 1 / 2.75 > t ? 7.5625 * t * t : 2 / 2.75 > t ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375, e ? .5 * (1 - t) : .5 * t + .5 })), u("Circ", h("CircOut", function(t) { return Math.sqrt(1 - (t -= 1) * t) }), h("CircIn", function(t) { return -(Math.sqrt(1 - t * t) - 1) }), h("CircInOut", function(t) { return (t *= 2) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1) })), s = function(e, i, s) {
                    var n = l("easing." + e, function(t, e) { this._p1 = t >= 1 ? t : 1, this._p2 = (e || s) / (1 > t ? t : 1), this._p3 = this._p2 / r * (Math.asin(1 / this._p1) || 0), this._p2 = r / this._p2 }, !0),
                        o = n.prototype = new t;
                    return o.constructor = n, o.getRatio = i, o.config = function(t, e) { return new n(t, e) }, n
    ...
    function(t, e) {
        ...
        if (!i.TweenLite) {
            var s, n, o, r, a, l = function(t) {
                    var e, s = t.split("."),
                        n = i;
                    for (e = 0; e < s.length; e++) n[s[e]] = n = n[s[e]] || {};
                    return n
                },
                h = l("com.greensock"),
                c = function(t) {
                ...
                f = function(e, s, n, o) {
                    ...
                    this.check = function(a) {
                        for (var h, c, u, p, m, g = s.length, _ = g; --g > -1;)(h = d[s[g]] || new f(s[g], [])).gsClass ? (r[g] = h.gsClass, _--) : a && h.sc.push(this);
                        if (0 === _ && n)
                            for (c = ("com.greensock." + e).split("."), u = c.pop(), p = l(c.join("."))[u] = this.gsClass = n.apply(n, r), o && (i[u] = p, !(m = "undefined" != typeof module && module.exports) && "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], function() { return p }) : "TweenMax" === e && m && (module.exports = p)), g = 0; g < this.sc.length; g++) this.sc[g].check()
                    }, this.check(!0)
                },
                m = t._gsDefine = function(t, e, i, s) { return new f(t, e, i, s) },
                g = h._class = function(t, e, i) { return e = e || function() {}, m(t, [], function() { return e }, i), e };
            m.globals = i;
            var _ = [0, 0, 1, 1],
                v = [],
                b = g("easing.Ease", function(t, e, i, s) { this._func = t, this._type = i || 0, this._power = s || 0, this._params = e ? _.concat(e) : _ }, !0),
                y = b.map = {},
                w = b.register = function(t, e, i, s) {
                    for (var n, o, r, a, l = e.split(","), c = l.length, u = (i || "easeIn,easeOut,easeInOut").split(","); --c > -1;)
                        for (o = l[c], n = s ? g("easing." + o, null, !0) : h.easing[o] || {}, r = u.length; --r > -1;) a = u[r], y[o + "." + a] = y[a + o] = n[a] = t.getRatio ? t : t[a] || new t
                };
            for ((o = b.prototype)._calcEnd = !1, o.getRatio = function(t) {
                ...
                }, n = (s = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --n > -1;) o = s[n] + ",Power" + n, w(new b(null, null, 1, n), o, "easeOut", !0), w(new b(null, null, 2, n), o, "easeIn" + (0 === n ? ",easeNone" : "")), w(new b(null, null, 3, n), o, "easeInOut");
            y.linear = h.easing.Linear.easeIn, y.swing = h.easing.Quad.easeInOut;
            var x = g("events.EventDispatcher", function(t) { this._listeners = {}, this._eventTarget = t || this });
            (o = x.prototype).addEventListener = function(t, e, i, s, n) {
                n = n || 0;
                var o, l, h = this._listeners[t],
                    c = 0;
                for (null == h && (this._listeners[t] = h = []), l = h.length; --l > -1;)(o = h[l]).c === e && o.s === i ? h.splice(l, 1) : 0 === c && o.pr < n && (c = l + 1);
                h.splice(c, 0, { c: e, s: i, up: s, pr: n }), this !== r || a || r.wake()
            ...
            var T = t.requestAnimationFrame,
                ...
                S = C();
            for (n = (s = ["ms", "moz", "webkit", "o"]).length; --n > -1 && !T;) T = t[s[n] + "RequestAnimationFrame"], k = t[s[n] + "CancelAnimationFrame"] || t[s[n] + "CancelRequestAnimationFrame"];
            g("Ticker", function(t, e) {
                var i, s, n, o, l, h = this,
                    c = C(),
                    p = !(!1 === e || !T) && "auto",
                    d = 500,
                    f = 33,
            ...
            var E = function() { a && C() - S > 2e3 && r.wake(), setTimeout(E, 2e3) };
            ...
            }, o.reversed = function(t) { return arguments.length ? (t != this._reversed && (this._reversed = t, this.totalTime(this._timeline && !this._timeline.smoothChildTiming ? this.totalDuration() - this._totalTime : this._totalTime, !0)), this) : this._reversed }, o.paused = function(t) { if (!arguments.length) return this._paused; var e, i, s = this._timeline; return t != this._paused && s && (a || t || r.wake(), e = s.rawTime(), i = e - this._pauseTime, !t && s.smoothChildTiming && (this._startTime += i, this._uncache(!1)), this._pauseTime = t ? e : null, this._paused = t, this._active = this.isActive(), !t && 0 !== i && this._initted && this.duration() && (e = s.smoothChildTiming ? this._totalTime : (e - this._startTime) / this._timeScale, this.render(e, e === this._totalTime, !0))), this._gc && !t && this._enabled(!0, !1), this };
            var A = g("core.SimpleTimeline", function(t) { P.call(this, 0, t), this.autoRemoveChildren = this.smoothChildTiming = !0 });
            ...
            var R = [],
                $ = {},
                M = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
                I = function(t) { for (var e, i = this._firstPT; i;) e = i.blob ? t ? this.join("") : this.start : i.c * t + i.s, i.r ? e = Math.round(e) : 1e-6 > e && e > -1e-6 && (e = 0), i.f ? i.fp ? i.t[i.p](i.fp, e) : i.t[i.p](e) : i.t[i.p] = e, i = i._next },
                L = function(t, e, i, s) {
                    var n, o, r, a, l, h, c, u = [t, e],
                        p = 0,
                        d = "",
                        f = 0;
                    for (u.start = t, i && (i(u), t = u[0], e = u[1]), u.length = 0, n = t.match(M) || [], o = e.match(M) || [], s && (s._next = null, s.blob = 1, u._firstPT = s), l = o.length, a = 0; l > a; a++) c = o[a], h = e.substr(p, e.indexOf(c, p) - p), d += h || !a ? h : ",", p += h.length, f ? f = (f + 1) % 5 : "rgba(" === h.substr(-5) && (f = 1), c === n[a] || n.length <= a ? d += c : (d && (u.push(d), d = ""), r = parseFloat(n[a]), u.push(r), u._firstPT = { _next: u._firstPT, t: u, p: u.length - 1, s: r, c: ("=" === c.charAt(1) ? parseInt(c.charAt(0) + "1", 10) * parseFloat(c.substr(2)) : parseFloat(c) - r) || 0, f: 0, r: f && 4 > f }), p += c.length;
                    return (d += e.substr(p)) && u.push(d), u.setRatio = I, u
                },
                N = function(t, e, i, s, n, o, r, a) {
                    var l, h, c = "get" === i ? t[e] : i,
                        u = typeof t[e],
                        p = "string" == typeof s && "=" === s.charAt(1),
                        d = { t: t, p: e, s: c, f: "function" === u, pg: 0, n: n || e, r: o, pr: 0, c: p ? parseInt(s.charAt(0) + "1", 10) * parseFloat(s.substr(2)) : parseFloat(s) - c || 0 };
                ...
                z = D._internals = { isArray: p, isSelector: O, lazyTweens: R, blobDif: L },
                j = D._plugins = {},
                F = z.tweenLookup = {},
                H = 0,
                ...
                V = z.lazyRender = function() {
                    var t, e = R.length;
                    for ($ = {}; --e > -1;)(t = R[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
                    R.length = 0
                };
            ...
            var U = function(t, e, i) {
                    ...
                    if (F[o || (t._gsTweenID = o = "t" + H++)] || (F[o] = { target: t, tweens: [] }), e && (s = F[o].tweens, s[n = s.length] = e, i))
                        for (; --n > -1;) s[n] === e && s.splice(n, 1);
                    return F[o].tweens
                },
                Q = function(t, e, i, s) { var n, o, r = t.vars.onOverwrite; return r && (n = r(t, e, i, s)), (r = D.onOverwrite) && (o = r(t, e, i, s)), !1 !== n && !1 !== o },
                G = function(t, e, i, s, n) {
                    ...
                    var h, c = e._startTime + 1e-10,
                        ...
                        p = 0,
                        d = 0 === e._duration;
                    for (o = n.length; --o > -1;)(a = n[o]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || Z(e, 0, d), 0 === Z(a, h, d) && (u[p++] = a)) : a._startTime <= c && a._startTime + a.totalDuration() / a._timeScale > c && ((d || !a._initted) && c - a._startTime <= 2e-10 || (u[p++] = a)));
                    for (o = p; --o > -1;)
            ...
            o._init = function() {
                ...
                if (o.startAt) {
                    ...
                    if (n.overwrite = !1, n.immediateRender = !0, n.lazy = l && !1 !== o.lazy, n.startAt = n.delay = null, this._startAt = D.to(this.target, 0, n), l)
                        if (this._time > 0) this._startAt = null;
                        else if (0 !== a) return
                } else if (o.runBackwards && 0 !== a)
                    if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                    else { 0 !== this._time && (l = !1), i = {}; for (s in o) X[s] && "autoCSS" !== s || (i[s] = o[s]); if (i.overwrite = 0, i.data = "isFromStart", i.lazy = l && !1 !== o.lazy, i.immediateRender = l, this._startAt = D.to(this.target, 0, i), l) { if (0 === this._time) return } else this._startAt._init(), this._startAt._enabled(!1), this.vars.immediateRender && (this._startAt = null) }
                if (this._ease = h = h ? h instanceof b ? h : "function" == typeof h ? new b(h, o.easeParams) : y[h] || D.defaultEase : D.defaultEase, o.easeParams instanceof Array && h.config && (this._ease = h.config.apply(h, o.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
                ...
                if (e && D._onPluginEvent("_onInitAllProps", this), r && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), o.runBackwards)
                ...
                $[e._gsTweenID] && V(), this.vars.css || e.style && e !== t && e.nodeType && j.css && !1 !== this.vars.autoCSS && function(t, e) {
                    var i, s = {};
                    for (i in t) X[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!j[i] || j[i] && j[i]._autoCSS) || (s[i] = t[i], delete t[i]);
                    t.css = s
                }(this.vars, e);
                for (o in this.vars)
                    if (c = this.vars[o], X[o]) c && (c instanceof Array || c.push && p(c)) && -1 !== c.join("").indexOf("{self}") && (this.vars[o] = c = this._swapSelfInParams(c, this));
                    else if (j[o] && (l = new j[o])._onInitTween(e, this.vars[o], this)) {
                    for (this._firstPT = h = { _next: this._firstPT, t: l, p: "setRatio", s: 0, c: 1, f: 1, n: o, pg: 1, pr: l._priority }, r = l._overwriteProps.length; --r > -1;) i[l._overwriteProps[r]] = this._firstPT;
                ...
                var s, n, o, r, a = this._time,
                    l = this._duration,
                    h = this._rawPrevTime;
                if (t >= l - 1e-7) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (s = !0, n = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > h || 0 >= t && t >= -1e-7 || 1e-10 === h && "isPause" !== this.data) && h !== t && (i = !0, h > 1e-10 && (n = "onReverseComplete")), this._rawPrevTime = r = !e || t || h === t ? t : 1e-10);
                else if (1e-7 > t) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== a || 0 === l && h > 0) && (n = "onReverseComplete", s = this._reversed), 0 > t && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (1e-10 !== h || "isPause" !== this.data) && (i = !0), this._rawPrevTime = r = !e || t || h === t ? t : 1e-10)), this._initted || (i = !0);
                ...
                return s
            }, D.killTweensOf = D.killDelayedCallsTo = function(t, e, i) { "object" == typeof e && (i = e, e = !1); for (var s = D.getTweensOf(t, e), n = s.length; --n > -1;) s[n]._kill(i, t) };
            var K = g("plugins.TweenPlugin", function(t, e) { this._overwriteProps = (t || "").split(","), this._propName = this._overwriteProps[0], this._priority = e || 0, this._super = K.prototype }, !0);
            if (o = K.prototype, K.version = "1.18.0", K.API = 2, o._firstPT = null, o._addTween = N, o.setRatio = I, o._kill = function(t) {
                    ...
                    return !1
                }, o._roundProps = function(t, e) { for (var i = this._firstPT; i;)(t[this._propName] || null != i.n && t[i.n.split(this._propName + "_").join("")]) && (i.r = e), i = i._next }, D._onPluginEvent = function(t, e) {
                    ...
                    return i
                }, K.activate = function(t) { for (var e = t.length; --e > -1;) t[e].API === K.API && (j[(new t[e])._propName] = t[e]); return !0 }, m.plugin = function(t) {
                    if (!(t && t.propName && t.init && t.API)) throw "illegal plugin definition.";
                    var e, i = t.propName,
                        s = t.priority || 0,
                        n = t.overwriteProps,
                        o = { init: "_onInitTween", set: "setRatio", kill: "_kill", round: "_roundProps", initAll: "_onInitAllProps" },
                        r = g("plugins." + i.charAt(0).toUpperCase() + i.substr(1) + "Plugin", function() { K.call(this, i, s), this._overwriteProps = n || [] }, !0 === t.global),
                        a = r.prototype = new K(i);
                    a.constructor = r, r.API = t.API;
                    for (e in o) "function" == typeof t[e] && (a[o[e]] = t[e]);
                    return r.version = t.version, K.activate([r]), r
                }, s = t._gsQueue) { for (n = 0; n < s.length; n++) s[n](); for (o in d) d[o].func || t.console.log("GSAP encountered missing dependency: com.greensock." + o) }
            a = !1
        }
    ...
    function(t) {
        ...
        function i() { _ = window.innerHeight || document.documentElement.clientHeight, v = window.innerWidth || document.documentElement.clientWidth, s() }

        function s() { g = !0, t(h).each(function() { t(this).data(a).refresh() }), setTimeout(function() { g = !1 }) }

        function n() { g = !0, t(h).each(function() { t(this).data(a).locate() }), setTimeout(function() { g = !1 }) }
        ...
        function o() {
            ...
            t(h).each(function() { t(this).data(a).enableWillChange(!e) })
        }
        ...
        var a = "jquery-stickit",
            ...
            d = window.StickScope = { Parent: 0, Document: 1 },
            f = { None: 0, Fixed: 1, Absolute: 2 },
            m = !1,
            g = !1;
        t.expr[":"][a] = function(e) { return !!t(e).data(a) }, e.prototype.trigger = function(t) {
            var e = "on" + t.charAt(0).toUpperCase() + t.slice(1);
            this.options[e] && this.options[e].call(this.element), this.element.trigger("stickit:" + t)
        }, e.prototype.isActive = function(t) { return (void 0 === t.screenMinWidth || v >= t.screenMinWidth) && (void 0 === t.screenMaxWidth || v <= t.screenMaxWidth) }, e.prototype.updateCss = function(t) {
        ...
        }, e.prototype.getZIndex = function(t) { return void 0 === t.zIndex ? this.defaultZIndex : t.zIndex }, e.prototype.getActiveOptionsKey = function() { for (var t = [], e = 0; e < this.optionList.length; ++e) this.isActive(this.optionList[e]) && t.push(e); return t.join("_") }, e.prototype.getActiveOptions = function() {
            ...
            this.origStyle = { width: t.style.width, position: t.style.position, left: t.style.left, top: t.style.top, bottom: t.style.bottom, zIndex: t.style.zIndex }
        }, e.prototype.restore = function() { this.element.css(this.origStyle) }, e.prototype.bound = function() {
            var t = this.element;
            if (c || "border-box" != t.css("box-sizing")) this.extraWidth = 0;
            else {
            ...
            this.margin = { top: parseFloat(t.css("margin-top")) || 0, bottom: parseFloat(t.css("margin-bottom")) || 0, left: parseFloat(t.css("margin-left")) || 0, right: parseFloat(t.css("margin-right")) || 0 }, this.parent = { border: { bottom: parseFloat(t.parent().css("border-bottom-width")) || 0 } }
        }, e.prototype.precalculate = function() { this.baseTop = this.margin.top + this.options.top, this.basePadding = this.baseTop + this.margin.bottom, this.baseParentOffset = this.options.extraHeight - this.parent.border.bottom, this.offsetHeight = this.options.overflowScrolling ? Math.max(this.element.outerHeight(!1) + this.basePadding - _, 0) : 0, this.minOffsetHeight = -this.offsetHeight }, e.prototype.reset = function() { this.stick == f.Absolute ? (this.trigger("unend"), this.trigger("unstick")) : this.stick == f.Fixed && this.trigger("unstick"), this.stick = f.None, this.spacer.css("width", this.origStyle.width), this.spacer[0].style.cssText += ";display: none !important", this.restore(), this.element.removeClass(this.options.className) }, e.prototype.setAbsolute = function(t) { this.stick == f.None ? (this.element.addClass(this.options.className), this.trigger("stick"), this.trigger("end")) : this.trigger("end"), this.stick = f.Absolute, this.element.css({ width: this.element.width() + this.extraWidth + "px", position: "absolute", top: this.origStyle.top, left: t + "px", bottom: -this.options.extraHeight + "px", "z-index": this.zIndex }) }, e.prototype.setFixed = function(t, e, i) { this.stick == f.None ? (this.element.addClass(this.options.className), this.trigger("stick")) : this.trigger("unend"), this.options.overflowScrolling || (i = 0), this.stick = f.Fixed, this.lastY = e, this.offsetY = i, this.element.css({ width: this.element.width() + this.extraWidth + "px", position: "fixed", top: this.options.top + i + "px", left: t + "px", bottom: this.origStyle.bottom, "z-index": this.zIndex }) }, e.prototype.updateScroll = function(t) {
        ...
        }, e.prototype.isHeigher = function() { return this.options.scope == d.Parent && this.element.parent().height() <= this.element.outerHeight(!1) + this.margin.bottom }, e.prototype.locate = function() {
            if (this.activeKey) {
        ...
        }, e.prototype.destroy = function() { this.reset(), this.spacer.remove(), this.element.removeData(a) }, e.prototype.enableWillChange = function(t) { "auto" == this.origWillChange && this.element.css("will-change", t ? "transform" : this.origWillChange) };
        var _, v, b = ["destroy", "refresh"];
        t.fn.stickit = function(s, l) {
            if ("string" == typeof s) {
                ...
                if (!m && (m = !0, i(), t(document).ready(function() { t(window).bind("resize", i).bind("scroll", n), t(document.body).bind("animationend webkitAnimationEnd oAnimationEnd transitionend webkitTransitionEnd oTransitionEnd", n), t(document).bind("webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange", o) }), p)) { new MutationObserver(r).observe(document, { attributes: !0, childList: !0, characterData: !0, subtree: !0 }) }
